/*!
 * @postscriptum.app/core 0.12.0-beta (September 6th 2022)
 * 
 * 
 * Includes:
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.unbreakableElement=exports.breakTable=exports.unbreak=exports.writeCounters=exports.breakAtPoint=void 0;const util_1=require("./util"),counters=require("./counters"),css_1=require("./css"),REPLACED_ELEMENTS=["img","object","video","audio","canvas","iframe","textarea","input","button"];function breakAtPoint(e,t,r="after"){const s=t.container.nodeType==Node.TEXT_NODE,n=s?t.container.parentElement:t.container,a=n==e;n.setAttribute("ps-breaking","");const o=counters.parseCounters(e,t),l=e.ownerDocument.createRange();"before"==r?(l.setStartBefore(e),l.setEnd(t.container,t.offset)):(l.setStart(t.container,t.offset),l.setEndAfter(e));const i=l.extractContents().firstElementChild;let u=a?e:e.querySelector("[ps-breaking]"),b=a?i:i.querySelector("[ps-breaking]");u.removeAttribute("ps-breaking"),b.removeAttribute("ps-breaking");let c=!1;for(;b!=i.parentElement;){let e,n;if("after"==r?(e=u,n=b):(e=b,n=u),e.setAttribute("ps-breaked-after",""),n.setAttribute("ps-breaked-before",""),o&&writeCounters(o,e,n),"ol"==b.localName?breakOrderedList(e,n):"table"==b.localName&&breakTable(e,n),s){const r=t.container;if(r.nodeValue.endsWith("\xad")){const e=getComputedStyle(r.parentElement);if("auto"==e.getPropertyValue("--ps-hyphens").trim()){const t=e.getPropertyValue("-webkit-hyphenate-character")[1]||"\u2010";r.nodeValue=r.nodeValue.slice(0,-1)+t,r.parentElement.setAttribute("ps-hyphen-last","")}}!c&&util_1.walk.displayAsBlock(e)&&(e.style.textAlignLast=e.style.MozTextAlignLast=getComputedStyle(e).textAlign,c=!0)}u=u.parentElement,b=b.parentElement}return i}function writeCounters(e,t,r){let s="",n="";for(const a in e){const o=e[a];for(let e=o.length-1;e>=0;e--){const l=o[e],i=l.element.parentElement;if(l.elemScope)i!=t.parentNode&&i!=r.parentNode||(n=" "+a+" "+l.value,o.splice(e,1));else if((i==t&&!l.element.hasAttribute("ps-breaked-after")||i==r&&!l.element.hasAttribute("ps-breaked-before"))&&(n=" "+a+" "+l.value,o.splice(e,1)),i==t.parentNode||i==r.parentNode){s+=" "+a+" "+l.value,o.splice(e,1);break}}}n?(r.setAttribute("ps-counters-on-desc",""),r.style.setProperty("--ps-counters-on-desc",n)):r.removeAttribute("ps-counters-on-desc"),s&&(r.setAttribute("ps-counters",""),r.style.counterReset=s)}function unbreak(e,t,r="before"){let s,n;if(e.removeAttribute("ps-breaked-after"),t.removeAttribute("ps-breaked-before"),"table"==e.localName?unbreakTable(e,t):"ol"==e.localName&&unbreakOrderedList(e,t),e.style.textAlignLast&&(e.style.textAlignLast=e.style.MozTextAlignLast=""),t.hasAttribute("ps-counters")&&(t.style.counterReset="",t.removeAttribute("ps-counters")),t.hasAttribute("ps-counters-on-desc")&&(t.style.removeProperty("--ps-counters-on-desc"),t.removeAttribute("ps-counters-on-desc")),util_1.walk.isHTMLElement(e.lastChild)&&e.lastChild.hasAttribute("ps-breaked-after")&&(s=e.lastChild,n=t.firstChild),s||e.hasAttribute("ps-hyphen-last")&&(e.lastChild.nodeValue=e.lastChild.nodeValue.slice(0,-1)+"\xad"),"before"==r){for(t.hasAttribute("ps-breaked-after")&&e.setAttribute("ps-breaked-after","");t.firstChild;)e.appendChild(t.firstChild);t.remove(),e.normalize()}else{for(e.hasAttribute("ps-breaked-before")&&t.setAttribute("ps-breaked-before",""),e.hasAttribute("ps-counters")&&(t.setAttribute("ps-counters",""),t.style.counterReset=e.style.counterReset),e.hasAttribute("start")&&t.setAttribute("start",e.getAttribute("start"));e.lastChild;)t.insertBefore(e.lastChild,t.firstChild);e.remove(),t.normalize()}s&&n&&unbreak(s,n,r)}function breakOrderedList(e,t){const r=Array.prototype.filter.call(e.children,e=>"list-item"==getComputedStyle(e).display);let s=e.hasAttribute("start")?parseInt(e.getAttribute("start")):1;t.firstElementChild&&t.firstElementChild.hasAttribute("ps-breaked-before")&&s--,t.setAttribute("start",s+r.length)}function breakTable(e,t){const r=e.getElementsByTagName("colgroup").item(0);r&&t.insertBefore(r.cloneNode(!0),t.firstChild);const s=css_1.getCustomStyle(e);!t.tHead&&t.tBodies.length&&e.tHead&&"no-repeat"!=css_1.getCustomProp(s,"repeat-thead")&&(t.tHead=e.tHead.cloneNode(!0),t.tHead.setAttribute("ps-repeated",""))}function unbreakOrderedList(e,t){t.removeAttribute("start")}function unbreakTable(e,t){const r=t.querySelectorAll("colgroup");for(let e=1;e<r.length;e++)r[e].remove()}function unbreakableElement(e){if(!(e instanceof HTMLElement))return"replacedElement";return"none"!=getComputedStyle(e).float?"float":e.style.height||e.style.minHeight?"intrisicDimension":REPLACED_ELEMENTS.includes(e.localName)&&util_1.walk.displayAsBlock(e)?"replacedElement":void 0}exports.breakAtPoint=breakAtPoint,exports.writeCounters=writeCounters,exports.unbreak=unbreak,exports.breakTable=breakTable,exports.unbreakableElement=unbreakableElement;

},{"./counters":3,"./css":4,"./util":20}],2:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.columnsSubProcessor=exports.createColumn=exports.Columnizator=exports.ColumnSpan=exports.Column=void 0;const layout_1=require("./layout"),util_1=require("./util"),mutations_1=require("./mutations"),util_2=require("./util"),fragments_1=require("./fragments"),breaks_1=require("./breaks"),css_1=require("./css"),flow_1=require("./flow");class Column extends fragments_1.Fragment{}exports.Column=Column;class ColumnSpan extends fragments_1.Fragment{}exports.ColumnSpan=ColumnSpan;class ColumnsGroup{constructor(){this.sequences=[],this.columnParent=null,this.span=null,this.columnsMut=null,this.spanMut=null}}class ColumnsLayoutContext extends layout_1.LayoutContext{constructor(t,e,o,s){super(e,e,o,s),this.maxHeightChanged=!1,s&&s.on("body-bottom-change",({newBottom:t})=>{this.maxHeightChanged=!0})}}class Columnizator extends fragments_1.Fragmentor{constructor(t,e){super(t,e),this.avoidBreakTypes=["avoid","avoid-column"],this.forcedBreakTypes=["always","column","-ps-column-span"],this.columnizationMut=new mutations_1.Mutations,this.breakPoint=null,this.logNoValidBreakPoint=!1,this.addSubProcessor(exports.columnsSubProcessor),this._process=this.columnizationProcess()}columnsMaxHeight(t){if(!this._maxBottom){const t=getComputedStyle(this.source);let e=css_1.computeMinOrMaxLength(t.maxHeight,this.source.parentElement.clientHeight,1/0);if(isNaN(e)&&(e=1/0),e==1/0)this._maxBottom=1/0;else{const t=util_1.rects.boundingScrollRect(this.source).top;this._maxBottom=t+e}}return this._maxBottom-t-.001}*columnizationProcess(){const t=css_1.getCustomStyle(this.source);if(this.columnCount=this.options.columnCount||parseColumnCount(this.source,t),!this.columnCount)throw new Error("No columns count defined on the source element.");this.columnizationMut.setAttr(this.source,"ps-process","pending"),this.listenerCount("start")&&(yield"start"),this.listenerCount("columnization-start")&&(yield"columnization-start"),this.columnizationMut.setAttr(this.source,"ps-columns",""),this.sourceBody=document.createElement("ps-column-body"),util_1.ranges.appendNodeContents(this.source,this.sourceBody),this.sourceBody.style.display="none",this.source.appendChild(this.sourceBody),this.columnizationMut.push({source:this.source,sourceBody:this.sourceBody,revert(){util_1.ranges.appendNodeContents(this.sourceBody,this.source),this.sourceBody.remove()}}),this.fillProp=css_1.getCustomProp(t,"column-fill");let e=css_1.getCustomProp(t,"column-gap");"normal"==e&&(e="1em"),this.columnizationMut.setStyle(this.source,{"--ps-gap":e});let o=css_1.getCustomProp(t,"column-rule");if(!o){o=(css_1.getCustomProp(t,"column-rule-style")||"none")+" "+(css_1.getCustomProp(t,"column-rule-width")||"medium")+" "+(css_1.getCustomProp(t,"column-rule-color")||getComputedStyle(this.source).color)}o.match(/(^|\s)none($|\s)?/)||this.columnizationMut.setStyle(this.source,{"--ps-rule":o});const s=new flow_1.FlowIterator(this.sourceBody,this.forcedBreakTypes);s.columnSpanBreak=css_1.getCustomProp(t,"column-span-break"),this.isLastGroup=!1;let n=s.next();const r=[];let i,u,a;do{i=new ColumnsGroup,r.push(i),u=!1;do{const t=new mutations_1.Mutations,e=t.breaks(this.sourceBody,{container:n.range.endContainer,offset:n.range.endOffset},"before");e.setAttribute("ps-column-sequence",""),e.style.display="","-ps-column-span"==n.breakType?i.span?breaks_1.unbreak(i.span,e,"before"):(i.spanMut=new mutations_1.Mutations,t.commit(i.spanMut),i.span=e):(i.columnsMut=new mutations_1.Mutations,t.commit(i.columnsMut),i.sequences.push(e)),this.isLastGroup=s.remaining.collapsed,n=s.next(),u=i.sequences.length>=this.columnCount+1}while(n&&!u&&(!i.span||"-ps-column-span"==n.breakType));yield*this.columnsGroupProcess(i)}while(!this.isLastGroup&&null===this.breakPoint&&!u);const l=r.flatMap(t=>{const e=[];return t.columnParent&&e.push({element:t.columnParent,mutations:t.columnsMut}),t.span&&t.span.isConnected&&e.push({element:t.span,mutations:t.spanMut}),e});i.span&&!i.span.isConnected&&breaks_1.unbreak(i.span,this.sourceBody,"after");for(let t=i.sequences.length-1;t>=0;t--)i.sequences[t].isConnected||breaks_1.unbreak(i.sequences[t],this.sourceBody,"after");if(this.breakPoint){for(let t=l.length-1;t>=0;t--)l[t].mutations.commit(this.columnizationMut);a=breaks_1.breakAtPoint(this.currentFragment.body,this.breakPoint),this.breakPoint=util_1.ranges.positionBefore(this.sourceBody),breaks_1.unbreak(a,this.sourceBody,"before"),this.columnizationMut.push({remainingBody:a,fragmentBody:this.currentFragment.body,revert(){breaks_1.unbreak(this.fragmentBody,this.remainingBody,"before")}})}else{let t=l.length-1;!1===this.breakPoint&&l[t--].mutations.revert();let e=-1;for(let o=t;o>=0;o--){const t=l[o];if("avoid"!==t.element.getAttribute("ps-break-after")){e=o;break}t.mutations.revert()}if(-1==e)this.breakPoint=!1;else{for(let t=0;t<=e;t++)l[t].mutations.commit(this.columnizationMut);this.breakPoint=this.sourceBody.firstChild?util_1.ranges.positionBefore(this.sourceBody):null}(a=this.sourceBody).remove()}this.columnizationMut.appendNodeContents(a,this.source),this.columnizationMut.setAttr(this.source,"ps-process","ended"),this.listenerCount("columnization-end")&&(yield"columnization-end"),this.listenerCount("end")&&(yield"end")}*columnsGroupProcess(t){if(t.sequences.length){const e=[],o=t.columnParent=this.doc.createElement("ps-columns");t.columnsMut.setAttr(o,"ps-process","pending"),this.source.insertBefore(o,this.sourceBody);for(let t=0;t<this.columnCount;t++){const s=createColumn(this.doc,t+1);if(0!=t){const t=document.createElement("ps-column-gap");this.source.style.getPropertyValue("--ps-rule")&&t.appendChild(document.createElement("ps-column-rule")),o.appendChild(t)}o.appendChild(s.container),fragments_1.createAreas(s,css_1.getCustomProp(this.source,"areas")),e.push(s),this.fragments.push(s)}t.columnsMut.push({columnsParent:o,revert(){o.remove()}});const s=getComputedStyle(this.source),n=s.lineHeight,r="normal"==n?1.15*parseInt(s.fontSize):parseInt(n);let i=null!=t.span,u=!1;const a=util_1.rects.boundingScrollRect(o).top;let l=this.columnsMaxHeight(a);const c=new mutations_1.Mutations;do{const s=e[0];let n=i||this.isLastGroup&&(l==1/0||"auto"!=this.fillProp);if(n&&!u){let e=r;for(let o=t.sequences.length-1;o>=0;o--){const n=t.sequences[o];s.body=s.container.insertBefore(n,s.container.firstChild);const r=n.scrollHeight/(this.columnCount-t.sequences.length+1);r>e&&(e=r),0!=o&&n.remove()}e<l?l=e:n=!1}else s.body=s.container.insertBefore(t.sequences[0],s.container.firstChild);t.columnsMut.push({firstColumn:s,revert(){this.firstColumn.body.remove()}}),c.push({columns:e,group:t,revert(){for(let t=this.columns.length-1;t>0;t--){const o=e[t];o.body&&(t>0&&this.group.sequences.includes(o.body)?o.body.remove():breaks_1.unbreak(e[t-1].body,o.body),o.body=null)}}}),u=!1;let m=!1;t.columnsMut.setStyle(o,{height:l+"px"});let h=0,p=0,d=e[p];do{this.currentFragment=d,this.breakPoint=null,util_1.logger.addScope(`column ${d.number}`),this.onFragmentStart(d,!1);const s=Object.assign({},this.options.parentAreas,d.areas),i=yield*this.contentsProcess(d.body,s,layout_1.isSubFragmentor(this)&&this.parentFragmentor.layoutContext),g=this.columnsMaxHeight(a);if(this.layoutContext.maxHeightChanged&&l>g){l=g,n=!1,u=!0,util_1.logger.removeScope();break}if(n){let t="no-break-point"==i;if(!t){const o=e[e.length-1].body;t="valid-break-point"==i&&o&&o.scrollHeight>=o.clientHeight}if(t&&l+r<g){l+=r,u=!0,util_1.logger.removeScope();break}"valid-break-point"==i&&(this.breakPoint=this.layoutContext.breakPoint)}else{if("no-break-point"==i){this.layoutContext.mutations.revert(),this.fragmentStartMut.revert(),c.revert(),this.breakPoint=!1,util_1.logger.removeScope();break}"valid-break-point"==i&&(this.breakPoint=this.layoutContext.breakPoint)}if(util_1.logger.removeScope(),++p==e.length)m=!0;else if(this.breakPoint){const t=breaks_1.breakAtPoint(d.body,this.breakPoint);this.onFragmentBreak(d),(d=e[p]).body=d.container.insertBefore(t,d.container.firstChild),this.breakPoint=null}else++h<t.sequences.length?(d=e[p]).body=d.container.insertBefore(t.sequences[h],d.container.firstChild):(o.style.height="",t.columnsMut.setStyle(o,{"max-height":l+"px"}),m=!0)}while(!m);if(!u&&i&&null===this.breakPoint){this.fragmentStartMut.commit(c),this.layoutContext.mutations.commit(c),c.commit(t.columnsMut),t.columnsMut.setAttr(o,"ps-process","ended");const e=yield*this.columnSpanProcess(t);"no-break-point"==e?(this.layoutContext.mutations.revert(),this.fragmentStartMut.revert(),this.breakPoint=!1):"valid-break-point"==e&&(this.fragmentStartMut.commit(c),this.layoutContext.mutations.commit(t.spanMut),this.breakPoint=this.layoutContext.breakPoint),i=!1}else u?(this.layoutContext.mutations.revert(),this.fragmentStartMut.revert(),c.revert(),this.breakPoint=null):!1!==this.breakPoint&&(this.fragmentStartMut.commit(c),this.layoutContext.mutations.commit(c))}while(u);c.commit(t.columnsMut),t.columnsMut.setAttr(o,"ps-process","ended")}else{const e=yield*this.columnSpanProcess(t);"no-break-point"==e?(this.layoutContext.mutations.revert(),this.breakPoint=!1):"valid-break-point"==e&&(this.layoutContext.mutations.commit(t.spanMut),this.breakPoint=this.layoutContext.breakPoint)}}*columnSpanProcess(t){util_1.logger.addScope("column-span");const e=this.currentFragment=new ColumnSpan;e.body=t.span,this.source.insertBefore(e.body,this.sourceBody);const o=util_1.rects.boundingScrollRect(e.body).top;e.body.style.height=this.columnsMaxHeight(o)+"px";const s=yield*this.contentsProcess(e.body,this.options.parentAreas,layout_1.isSubFragmentor(this)&&this.parentFragmentor.layoutContext);if(e.body.style.height="",this.parentAvoidBreakTypes){let o=e.body;do{if(!util_2.walk.isElement(o))break;if(this.parentAvoidBreakTypes.includes(css_1.getCustomProp(o,"break-after"))){t.spanMut.setAttr(e.body,"ps-break-after","avoid");break}o=util_2.walk.lastChild(o,util_2.walk.isStaticNode)}while(o&&util_2.walk.isElement(o))}return util_1.logger.removeScope(),s}createLayoutContext(t,e,o){return new ColumnsLayoutContext(this.source,t,e,o)}}function createColumn(t,e){const o=new Column;return o.container=t.createElement("ps-column"),o.number=e,o}exports.Columnizator=Columnizator,Columnizator.defaultOptions=Object.assign({parentAreas:{},parentLayoutContext:null},fragments_1.Fragmentor.defaultOptions),exports.createColumn=createColumn;const columnsSubProcessor=function(t){const e=parseColumnCount(t.currentElement,t.currentCustomStyle);if(!e)return!1;const o=new class extends Columnizator{constructor(t,e,o){super(e,o),this.parentFragmentor=t,this.gcpmContext=t.gcpmContext}columnsMaxHeight(e){const o=this.parentFragmentor.layoutContext.bottomOffsets.get(this.source).after;let s=this.parentFragmentor.layoutContext.bodyBottom-o-e;return"content-box"==t.currentStyle.boxSizing&&(s=util_1.rects.contentSizingHeight(t.currentStyle,s)),Math.min(super.columnsMaxHeight(e),s)}emit(t,e){super.emit(t,e);const o="string"==typeof t?{type:t}:t;"start"!=o.type&&"end"!=o.type&&this.parentFragmentor.emit(t)}}(this,t.currentElement,Object.assign(Object.create(fragments_1.Fragmentor.defaultOptions),{parentAreas:t.areas,columnCount:e}));return o.parentAvoidBreakTypes=this.avoidBreakTypes,o.start().ended.then(()=>(o.columnizationMut.commit(this.layoutContext.mutations),o.breakPoint?{breakPoint:o.breakPoint}:!1!==o.breakPoint&&void 0))};function parseColumnCount(t,e){let o=0;const s=css_1.getCustomProp(e,"column-count");if("auto"!=s)o=parseInt(s);else{const s=css_1.getCustomProp(e,"column-width"),n=t.clientWidth;if("auto"!=s){const t=css_1.computeLength(s,n);let r=css_1.getCustomProp(e,"column-gap");"normal"==r&&(r="1em");const i=css_1.computeLength(r,n);if((o=Math.floor(n/t))>1)for(;o>1&&o*t+i*(o-1)>n;)o--}}return isNaN(o)||1==o?0:o}exports.columnsSubProcessor=columnsSubProcessor;

},{"./breaks":1,"./css":4,"./flow":7,"./fragments":8,"./layout":12,"./mutations":13,"./util":20}],3:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.addElementCounters=exports.resetFromCounters=exports.parseCounters=exports.getPageCounterValue=exports.getCounterValue=exports.parseCounterValue=void 0;const util_1=require("./util"),util_2=require("./util"),valueParser=require("postcss-value-parser");function parseCounterValue(e){const t={};if("none"==e)return t;const r=valueParser(e).nodes.filter(e=>"word"==e.type);for(let e=0;e<r.length;e++){const n=r[e].value,o=parseInt(r[e+1].value);e++,t[n]=o}return t}function getCounterValue(e,t){const r=e.ownerDocument,n=util_1.walk.createWalker(r.documentElement,util_1.walk.isElement);let o=0;for(n.currentNode=e;n.currentNode!=r.documentElement;){let e=!1;const r=getComputedStyle(n.currentNode);if("none"!=r.display){const n=parseCounterValue(r.counterReset);t in n&&(o+=n[t],e=!0);const u=parseCounterValue(r.counterIncrement);if(t in u&&(o+=u[t]),e)return o}n.previousNode()}return util_2.logger.warn(`Counter '${t}' without a counter-reset.`),o}function getPageCounterValue(e,t){let r=t;for(;r&&"ps-page"!=r.localName;)r=r.parentElement;for(let t=0;t<e.length;t++)if(r==e[t].container)return t+1;throw"Page not found"}function parseCounters(e,t){const r={},n=util_1.ranges.nodeAtPoint(t),o=e.ownerDocument.documentElement;let u=e;for(;u!=o&&!u.hasAttribute("ps-counters");)u=u.parentElement;const l=util_1.walk.createWalker(u,util_1.walk.isElement);do{if(l.currentNode==n||l.currentNode.compareDocumentPosition(n||t.container)&Node.DOCUMENT_POSITION_PRECEDING)break;if(addElementCounters(l.currentNode,r,null,l.currentNode==e),addElementCounters(l.currentNode,r,"before",l.currentNode==e),!l.firstChild())for(;!l.nextSibling()&&l.currentNode!=u;){if(addElementCounters(l.currentNode,r,"after",l.currentNode==e),!l.currentNode.hasAttribute("ps-breaked-after"))for(const e in r){const t=r[e];if(t.length){const e=t[t.length-1];(e.elemScope&&e.element===l.currentNode||e.element.parentNode==l.currentNode.parentNode)&&t.pop()}}l.parentNode()}}while(l.currentNode!=u);return r}function resetFromCounters(e){let t="";for(const r in e){const n=e[r];n.length&&(t+=" "+r+" "+n[n.length-1].value)}return t}function addElementCounters(e,t,r=null,n=!1){const o=getComputedStyle(e,r?"::"+r:null);if(!n&&"none"==o.display)return;if(r&&"none"==o.content)return;const u=parseCounterValue(o.counterReset);for(const n in u){let o=t[n];o||(o=t[n]=[]),o.length&&o[o.length-1].element.parentNode==e.parentNode&&o.pop(),o.push({element:e,value:u[n],elemScope:null!=r})}const l=parseCounterValue(o.counterIncrement);for(const n in l){let o=t[n];o||(o=t[n]=[]),o.length||o.push({element:e,value:0,elemScope:null!=r}),o[o.length-1].value+=l[n]}}exports.parseCounterValue=parseCounterValue,exports.getCounterValue=getCounterValue,exports.getPageCounterValue=getPageCounterValue,exports.parseCounters=parseCounters,exports.resetFromCounters=resetFromCounters,exports.addElementCounters=addElementCounters;

},{"./util":20,"postcss-value-parser":32}],4:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.addStyleImagesToLoad=exports.computeMinOrMaxLength=exports.computeLength=exports.getCustomPluginProp=exports.getCustomProp=exports.getCustomStyle=exports.insertLinkSheet=exports.insertStyleSheet=exports.removeSheets=exports.cssContexts=exports.CssContext=exports.REGISTER_PROPERTIES=void 0;const postcss=require("postcss"),safeParser=require("postcss-safe-parser"),valueParser=require("postcss-value-parser"),precss_1=require("./precss"),util_1=require("./util"),core_css_1=require("./css/core-css"),default_css_1=require("./css/default-css"),hypher_1=require("./hypher");exports.REGISTER_PROPERTIES="CSS"in window&&"registerProperty"in CSS;class CssContext{constructor(e,t){this.doc=e,this.options=t,this.preparedSheets=new Set,this.coreSheet=null,this.defaultSheet=null,this.hyphers={}}*process(){this.options.authorCSS||removeSheets(this.doc);const e=this.doc.head.firstChild,t=this.options.defaultPageSize||[window.innerWidth+"px",window.innerHeight+"px"],s={defaultPageSize:t,mediaType:this.options.mediaType,propertiesRegistered:!1};this.options.coreCSS&&(this.coreSheet=insertStyleSheet(this.doc,core_css_1.default(t,exports.REGISTER_PROPERTIES),!0,"core-sheet",e)),this.options.defaultCSS&&(yield(async()=>{const t=await transform(default_css_1.default(),document.baseURI,s);this.defaultSheet=insertStyleSheet(this.doc,t.css,!0,"default-sheet",e)})());const o=[];for(const e of this.options.css)o.push(insertLinkSheet(this.doc,new URL(e,this.doc.baseURI)));if(yield(async()=>{await registerPaintModule("marks",MarksPainter),await util_1.dom.docComplete(this.doc),await Promise.all(o),this.options.preprocessCSS&&await this.prepareSheets(s)})(),"fonts"in this.doc){const e=[];for(const t of this.doc.fonts)"unloaded"==t.status?e.push(t.load()):"loading"==t.status&&e.push(t.loaded);e.length&&(yield Promise.all(e).catch(e=>{util_1.logger.warn("A font could not be loaded."),util_1.logger.error(e)}))}}async processStyleAttr(e){null==this._styleAttrProcessor&&(this._styleAttrProcessor=postcss().use(precss_1.styleAttrPlugin()));const t=e.getAttribute("style");if(null==t)return;const s=await this._styleAttrProcessor.process(t,{from:document.baseURI});e.setAttribute("style",s.css)}async prepareSheets(e){const t=[],s=Array.prototype.filter.call(this.doc.styleSheets,e=>{const t=e.ownerNode;return!t.hasAttribute("ps-excluded")&&!this.preparedSheets.has(t)});for(const o of s){const s=o.ownerNode;let r,n;s instanceof HTMLLinkElement?((r=s.cloneNode(!1)).setAttribute("ps-href",s.getAttribute("href")),n=util_1.io.load(r.href).then(t=>transform(t,s.href,e))):(r=document.createElement("link"),s.id&&(r.id=s.id),s.media&&(r.media=s.media),r.type="text/css",r.rel="stylesheet",n=transform(s.textContent,this.doc.baseURI,e)),t.push(n.then(e=>{const t=new Blob([e.css],{type:"text/css"});return r.href=URL.createObjectURL(t),this.options.mediaType&&s.media&&(r.media=precss_1.replaceMediaType(s.media,this.options.mediaType)),s.parentNode.replaceChild(r,s),this.preparedSheets.add(r),new Promise((e,t)=>{r.addEventListener("load",e),r.addEventListener("error",t)})}).catch(e=>{util_1.logger.warn(e.message||`An error occured while loading '${"href"in s?s.href:r.href}'`)}))}return Promise.all(t)}testHyphens(e,t){if("auto"!=t.getPropertyValue("--ps-hyphens").trim())return!1;let s="";for(let t=e;t&&!(s=t.lang);t=t.parentElement);if(!s)return!1;const o=new Intl.Locale(s);s=o.language,"en"==o.language&&(s="GB"==o.region?"en-gb":"en-us");const r=this.hyphers[s];return void 0!==r?r:this.options.hyphUri?util_1.io.load(`${this.options.hyphUri}/${s}.json`).then(e=>{const t=new hypher_1.Hypher(JSON.parse(e));return this.hyphers[s]=t,t}).catch(()=>{this.hyphers[s]=!1,util_1.logger.warn(`Failed to load the hyphenation patterns for language ${s}.`)}):void util_1.logger.warn("Hyphenation dictionaries URL (hyphUri) not defined.")}hyphenate(e,t){for(const s of e.childNodes)util_1.walk.isText(s)&&(s.nodeValue=t.hyphenateText(s.nodeValue))}}function transform(e,t,s){const o=s?[precss_1.default(s)]:[],r={from:t,parser:safeParser},n=postcss().use(precss_1.importUnfold(r));for(const e of o)n.use(e);return s&&n.use(precss_1.importFold),n.process(e,r)}function removeSheets(e){const t=e.querySelectorAll("style,link[rel=stylesheet]");for(const e of t)e.remove()}function insertStyleSheet(e,t,s,o,r){const n=e.createElement("style");return n.textContent=t,o&&(n.id=o),s&&n.setAttribute("ps-excluded",""),e.head.insertBefore(n,r),n.sheet}function insertLinkSheet(e,t,s,o,r){const n=e.createElement("link");return n.rel="stylesheet",n.type="text/css",n.href=t.toString(),o&&(n.id=o),s&&n.setAttribute("ps-excluded",""),new Promise((t,s)=>{n.addEventListener("load",()=>{t(n.sheet)}),n.addEventListener("error",()=>{s(n)}),e.head.insertBefore(n,r)})}function getCustomStyle(e){return exports.REGISTER_PROPERTIES?getComputedStyle(e):getComputedStyle(e,"::backdrop")}function getCustomProp(e,t){return util_1.dom.isElement(e)&&(e=getCustomStyle(e)),e.getPropertyValue(`--ps-${t}`).trim()}function getCustomPluginProp(e,t){return util_1.dom.isElement(e)&&(e=getCustomStyle(e)),e.getPropertyValue(`--psp-${t}`).trim()}function computeLength(e,t){let s=0;try{if(!(s=parseFloat(e)))return 0;const o=CSSUnitValue.parse(e);return"percent"==o.unit?("function"==typeof t&&(t=t()),t*s/100):o.to("px").value}catch(o){const r=e.trim().match(/([\d.]+)(px|vw|vh|vmin|vmax|cm|mm|in|pt|pc|%)$/);if(r){const[,,e]=r;if("%"==e)return"function"==typeof t&&(t=t()),t*s/100;if(e.startsWith("v")){const t=window.innerWidth,o=window.innerHeight;if("vw"==e)return s*t/100;if("vh"==e)return s*o/100;if("vmin"==e)return s*Math.min(t,o)/100;if("vmax"==e)return s*Math.max(t,o)/100;console.log(s)}else{if("px"==e)return s;{const t=96*s;switch(e){case"in":return t;case"cm":return t/2.54;case"mm":return t/25.4;case"pt":return t/72;case"pc":return t/6}}}}else util_1.logger.warn(`Unable to compute the length '${e}'.`)}}function computeMinOrMaxLength(e,t,s){return"none"==e?s:e.match(/^\d/)?computeLength(e,t):NaN}function addStyleImagesToLoad(e,t){const s=getComputedStyle(e).backgroundImage;if("none"!=s){const e=valueParser(s);for(const s of e.nodes.filter(e=>"function"==e.type))if("url"==s.value){const e=s.nodes[0].value;t.add(e)}}}exports.CssContext=CssContext,exports.cssContexts=new Map,exports.removeSheets=removeSheets,exports.insertStyleSheet=insertStyleSheet,exports.insertLinkSheet=insertLinkSheet,exports.getCustomStyle=getCustomStyle,exports.getCustomProp=getCustomProp,exports.getCustomPluginProp=getCustomPluginProp,exports.computeLength=computeLength,exports.computeMinOrMaxLength=computeMinOrMaxLength,exports.addStyleImagesToLoad=addStyleImagesToLoad;class MarksPainter{static get inputProperties(){return["--ps-bleed-size","--ps-marks"]}paint(e,{width:t,height:s},o){const r=o.get("--ps-marks")[0];if(!r||"none"==r)return;const n=o.get("--ps-bleed-size")[0];let i;if("parse"in CSSUnitValue)i=CSSUnitValue.parse(n);else{const e=n.match(/([\d.]+)(px|cm|mm|in|pt|pc)$/);i=new CSSUnitValue(parseFloat(e[1]),e[2])}const a=i.to("px").value;e.lineWidth=.5;const l=a/3;if(r.includes("crop")){const o=2*a/3;e.beginPath(),e.moveTo(l,a),e.lineTo(o,a),e.moveTo(a,l),e.lineTo(a,o),e.moveTo(t-a,l),e.lineTo(t-a,o),e.moveTo(t-o,a),e.lineTo(t-l,a),e.moveTo(t-l,s-a),e.lineTo(t-o,s-a),e.moveTo(t-a,s-l),e.lineTo(t-a,s-o),e.moveTo(a,s-l),e.lineTo(a,s-o),e.moveTo(l,s-a),e.lineTo(o,s-a),e.stroke()}if(r.includes("cross")){const o=t/2,r=s/2,n=a/2,i=a/6;e.beginPath(),e.arc(o,n,i,0,2*Math.PI),e.stroke(),e.beginPath(),e.arc(t-n,s/2,i,0,2*Math.PI),e.stroke(),e.beginPath(),e.arc(t/2,s-n,i,0,2*Math.PI),e.stroke(),e.beginPath(),e.arc(n,s/2,i,0,2*Math.PI),e.stroke(),e.beginPath(),e.moveTo(o-l,n),e.lineTo(o+l,n),e.moveTo(o,n-l),e.lineTo(o,n+l),e.moveTo(t-n-l,r),e.lineTo(t-n+l,r),e.moveTo(t-n,r-l),e.lineTo(t-n,r+l),e.moveTo(o-l,s-n),e.lineTo(o+l,s-n),e.moveTo(o,s-n-l),e.lineTo(o,s-n+l),e.moveTo(n-l,r),e.lineTo(n+l,r),e.moveTo(n,r-l),e.lineTo(n,r+l),e.stroke()}}}function registerPaintModule(e,t){if(!("paintWorklet"in CSS))return;const s=`registerPaint('${e}', ${t.toString()})`,o=new Blob([s],{type:"application/javascript"});return CSS.paintWorklet.addModule(URL.createObjectURL(o))}

},{"./css/core-css":5,"./css/default-css":6,"./hypher":10,"./precss":16,"./util":20,"postcss":49,"postcss-safe-parser":30,"postcss-value-parser":32}],5:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const customProps=[{name:"--ps-size",syntax:"*",initialValue:"auto"},{name:"--ps-page",syntax:"auto | <custom-ident>",initialValue:"auto"},{name:"--ps-break-before",syntax:"auto | avoid | always | all | avoid-page | page | left | right | recto | verso | avoid-column | column",initialValue:"auto"},{name:"--ps-break-after",syntax:"auto | avoid | always | all | avoid-page | page | left | right | recto | verso | avoid-column | column",initialValue:"auto"},{name:"--ps-break-inside",syntax:"*",initialValue:"auto"},{name:"--ps-position",syntax:"*",initialValue:"static"},{name:"--ps-float",syntax:"*",initialValue:"none"},{name:"--ps-float-display",syntax:"block | inline | compact",initialValue:"block"},{name:"--ps-float-policy",syntax:"auto | line | block",initialValue:"auto"},{name:"--ps-bookmark-level",syntax:"none | <integer>",initialValue:"none"},{name:"--ps-bookmark-label",syntax:"*",initialValue:"content(text)"},{name:"--ps-bookmark-state",syntax:"open | closed",initialValue:"open"},{name:"--ps-column-count",syntax:"<integer> | auto",initialValue:"auto"},{name:"--ps-column-width",syntax:"auto | <length>",initialValue:"auto"},{name:"--ps-column-gap",syntax:"normal | <length-percentage>",initialValue:"normal"},{name:"--ps-column-fill",syntax:"auto | balance",initialValue:"balance"},{name:"--ps-column-rule-style",syntax:"none | hidden | dotted | dashed | solid | double | groove | ridge | inset | outset",initialValue:"none"},{name:"--ps-column-rule-width",syntax:"<length> | thin | medium | thick",initialValue:"medium"},{name:"--ps-column-rule-color",syntax:"<color>",initialValue:"currentcolor"},{name:"--ps-column-span-break",syntax:"element | box",initialValue:"element"},{name:"--ps-repeat-thead",syntax:"repeat | no-repeat",initialValue:"repeat"},{name:"--ps-box-decoration-break",syntax:"slice | clone",initialValue:"slice"},{name:"--ps-box-remaining-extent",syntax:"fill | auto",initialValue:"auto"},{name:"--ps-margin-break",syntax:"auto | keep | discard",initialValue:"auto"},{name:"--ps-areas",syntax:"auto | <custom-ident>+",initialValue:"auto"},{name:"--ps-string-set",syntax:"*",initialValue:"none"}];function declareCustomProps(t){if(t){for(const t of customProps)"inherits"in t||(t.inherits=!1),CSS.registerProperty(t);return""}{let t="*::backdrop {";for(const n of customProps)t+=`${n.name}: ${n.initialValue};`;return t+="}"}}exports.default=((t,n)=>{let e=declareCustomProps(n);return"BackCompat"==document.compatMode&&(e+="body { height: fit-content; }"),e+=`\n\t:root {\n\t\t/* Firefox does not support orphans and widows, we use CSS variables for them */\n\t\t--ps-orphans: 2;\n\t\t--ps-widows: 2;\n\t\t/* The defaut hyphen character of Chrome is the hyphen-minus (U+002D). PS uses the hyphen (U+2010) to allow detection. */\n\t\t-webkit-hyphenate-character: '\\2010';\n\t\ttext-rendering: optimizeLegibility;\n\t}\n\n\tps-page {\n\t\tdisplay: block;\n\n\t\tcounter-increment: page;\n\t\tbox-sizing: border-box;\n\t\tpage-break-before: always;\n\n\t\tposition: relative;\n\t\toverflow: clip;\n\n\t\t--ps-page-width: ${t[0]};\n\t\t--ps-page-height: ${t[1]};\n\t\twidth: var(--ps-page-width);\n\t\theight: var(--ps-page-height);\n\n\t\t--ps-bleed: auto;\n\t\t--ps-marks: none;\n\t\tpadding-top: var(--ps-page-margin-top);\n\t\tpadding-right: var(--ps-page-margin-right);\n\t\tpadding-bottom: var(--ps-page-margin-bottom);\n\t\tpadding-left: var(--ps-page-margin-left);\n\t\tmargin-right: auto;\n\t}\n\n\tps-page[ps-bleed] {\n\t\tborder: solid var(--ps-bleed-size, 0) transparent;\n\t\toverflow-clip-margin: var(--ps-bleed-size);\n\t\twidth: calc(var(--ps-page-width) + var(--ps-bleed-size) + var(--ps-bleed-size));\n\t\theight: calc(var(--ps-page-height) + var(--ps-bleed-size) + var(--ps-bleed-size));\n\t}\n\n\tps-page[ps-bleed]:not([ps-bleed="none"])::before {\n\t\tcontent: "";\n\t\tposition: absolute;\n\t\t--ps-bleed-inv: calc(var(--ps-bleed-size) * -1);\n\t\ttop: var(--ps-bleed-inv);\n\t\tright: var(--ps-bleed-inv);\n\t\tbottom: var(--ps-bleed-inv);\n\t\tleft: var(--ps-bleed-inv);\n\n\t\tbackground-image: paint(marks);\n\t\tbackground-repeat: no-repeat;\n\t}\n\n\t@page {\n\t\tmargin: 0;\n\t}\n\n\tps-page:first-of-type {\n\t\tpage-break-before: auto;\n\t\tcounter-reset: page 0 footnote 0;\n\t}\n\n\tps-page-area {\n\t\tdisplay: flex;\n\t\tflex-direction: column;\n\t\theight: 100%;\n\t\tbox-sizing: border-box;\n\t}\n\n\tps-area {\n\t\toverflow: hidden;\n\t}\n\n\tps-area[ps-name=footnotes] {\n\t\toverflow: visible;\n\t\tposition: relative;\n\t\tz-index: -1;\n\t}\n\n\tps-area:empty {\n\t\tdisplay: none;\n\t}\n\n\t[ps-page-body] {\n\t\tdisplay: block;\n\t\tflex: 1 1 0;\n\t\tposition: relative;\n\t\t/* TODO doubts about this margin, but consistent with PrinceXML */\n\t\tmargin: 0;\n\t\torder: 0;\n\t\tmin-height: 0;\n\t}\n\n\tps-page[ps-processing] > ps-margin {\n\t\tdisplay: none;\n\t}\n\n\tps-page[ps-processing] > ps-page-area > [ps-page-body] {\n\t\t/*overflow: hidden;*/\n\t}\n\n\tps-margin {\n\t\tdisplay: flex;\n\t\tposition: absolute;\n\t\tz-index: 1;\n\t\tbox-sizing: border-box;\n\t}\n\n\tps-margin-box {\n\t\tdisplay: flex;\n\t\tbox-sizing: border-box;\n\t\tflex: 1 1 auto;\n\t}\n\n\tps-margin-box::before {\n\t\tdisplay: block;\n\t}\n\n\tps-margin-box[ps-name=top-left-corner] {\n\t\tposition: absolute;\n\t\ttop: 0;\n\t\tleft: 0;\n\t\twidth: var(--ps-page-margin-left);\n\t\theight: var(--ps-page-margin-top);\n\t\talign-items: center;\n\t\tjustify-content: flex-end;\n\t\ttext-align: right;\n\t}\n\n\tps-margin[ps-side=top] {\n\t\ttop: 0;\n\t\tleft: var(--ps-page-margin-left);\n\t\tright: var(--ps-page-margin-right);\n\t\theight: var(--ps-page-margin-top);\n\t}\n\n\tps-margin-box[ps-name=top-right-corner] {\n\t\tposition: absolute;\n\t\ttop: 0;\n\t\tright: 0;\n\t\twidth: var(--ps-page-margin-right);\n\t\theight: var(--ps-page-margin-top);\n\t\talign-items: center;\n\t\tjustify-content: flex-start;\n\t\ttext-align: left;\n\t}\n\n\tps-margin[ps-side=right] {\n\t\tright: 0;\n\t\ttop: var(--ps-page-margin-top);\n\t\tbottom: var(--ps-page-margin-bottom);\n\t\twidth: var(--ps-page-margin-right);\n\t\tflex-direction: column;\n\t}\n\n\tps-margin-box[ps-name=bottom-right-corner] {\n\t\tposition: absolute;\n\t\tright: 0;\n\t\tbottom: 0;\n\t\theight: var(--ps-page-margin-bottom);\n\t\twidth: var(--ps-page-margin-right);\n\t\talign-items: center;\n\t\tjustify-content: flex-start;\n\t\ttext-align: left;\n\t}\n\n\tps-margin[ps-side=bottom] {\n\t\tbottom: 0;\n\t\tright: var(--ps-page-margin-right);\n\t\tleft: var(--ps-page-margin-left);\n\t\theight: var(--ps-page-margin-bottom);\n\t}\n\n\tps-margin-box[ps-name=bottom-left-corner] {\n\t\tposition: absolute;\n\t\tleft: 0;\n\t\tbottom: 0;\n\t\theight: var(--ps-page-margin-bottom);\n\t\twidth: var(--ps-page-margin-left);\n\t\talign-items: center;\n\t\tjustify-content: flex-end;\n\t\ttext-align: right;\n\t}\n\n\tps-margin[ps-side=left] {\n\t\tleft: 0;\n\t\ttop: var(--ps-page-margin-top);\n\t\tbottom: var(--ps-page-margin-bottom);\n\t\twidth: var(--ps-page-margin-left);\n\t\tflex-direction: column;\n\t}\n\n\t/* cf. http://www.w3.org/TR/css3-page/#margin-values */\n\tps-margin-box[ps-name=top-left],\n\tps-margin-box[ps-name=bottom-left] {\n\t\talign-items: center;\n\t\tjustify-content: flex-start;\n\t\ttext-align: left;\n\t}\n\n\tps-margin-box[ps-name=top-center],\n\tps-margin-box[ps-name=bottom-center] {\n\t\talign-items: center;\n\t\tjustify-content: center;\n\t\ttext-align: center;\n\t}\n\n\tps-margin-box[ps-name=top-right],\n\tps-margin-box[ps-name=bottom-right] {\n\t\talign-items: center;\n\t\tjustify-content: flex-end;\n\t\ttext-align: right;\n\t}\n\n\tps-margin-box[ps-name=right-top],\n\tps-margin-box[ps-name=left-top] {\n\t\talign-items: flex-start;\n\t\tjustify-content: center;\n\t\ttext-align: center;\n\t}\n\n\tps-margin-box[ps-name=right-middle],\n\tps-margin-box[ps-name=left-middle] {\n\t\talign-items: center;\n\t\tjustify-content: center;\n\t\ttext-align: center;\n\t}\n\n\tps-margin-box[ps-name=right-bottom],\n\tps-margin-box[ps-name=left-bottom] {\n\t\talign-items: flex-end;\n\t\tjustify-content: center;\n\t\ttext-align: center;\n\t}\n\n\t[ps-float-base] {\n\t\tdisplay: none !important;\n\t}\n\n\t[ps-float-call] {\n\t\tcolor: inherit;\n\t\ttext-decoration: inherit;\n\t\tunicode-bidi: isolate;\n\t}\n\t\n\t/* cf https://drafts.csswg.org/css-gcpm/#float-call */\n\t[ps-float-display='block'] {\n\t\tdisplay: list-item;\n\t\tlist-style-position: inside;\n\t\tlist-style-type: none;\n\t}\n\n\t/* TODO */\n\t[ps-float-display='inline'] {\n\t}\n\n\t[ps-float-display='compact'] {\n\t\tdisplay: inline-flex;\n\t}\n\n  [ps-float-call], [ps-float-call]::before {\n\t  all: unset;\n  }\n\n  ps-bookmarks {\n\t\tdisplay: none;\n\t}\n\n\t[ps-running] {\n\t\tdisplay: none !important;\n\t}\n\n\t[ps-breaked-before] {\n\t\tcounter-increment: none !important;\n\t\ttext-indent: 0;\n\t}\n\n\t[ps-breaked-before]:not([ps-box-decoration-break=clone]) {\n\t\tpadding-top: 0 !important;\n\t\tborder-top: none !important;\n\t\tborder-top-left-radius: 0 !important;\n\t\tborder-top-right-radius: 0 !important;\n\t}\n\n\t[ps-breaked-after]:not([ps-box-decoration-break=clone]) {\n\t\tpadding-bottom: 0 !important;\n\t\tborder-bottom: none !important;\n\t\tborder-bottom-left-radius: 0 !important;\n\t\tborder-bottom-right-radius: 0 !important;\n\t}\n\n\t[ps-margin-break-before=discard] {\n\t\tmargin-top: 0 !important;\n\t}\n\n\t[ps-breaked-after]:not([ps-margin-break-after=keep]) {\n\t\tmargin-bottom: 0 !important;\n\t}\n\n\t/* TODO Is there some case where a counter-reset in not overridden ? */\n\t/*\n\t[ps-breaked-before]:not([ps-counters]) {\n\t  counter-reset: none !important;\n\t  counter-increment: none !important;\n\t}\n\t*/\n\n\tli[ps-breaked-before] {\n\t\tlist-style-type: none !important;\n\t\tlist-style-image: none !important;\n\t}\n\n\t[ps-breaked-before]::before {\n\t\tcontent: none !important;\n\t}\n\n\t[ps-breaked-after]::after {\n\t\tcontent: none !important;\n\t}\n\t\n\t[ps-counters-on-desc]::before {\n\t\tcontent: '' !important;\n\t\tcounter-reset: var(--ps-counters-on-desc);\n\t}\n\n\t[ps-row=table-row] > *[ps-breaked-before] {\n\t\tvertical-align: top;\n\t}\n\n\t[ps-row=table-row] > *[ps-breaked-after]:not([ps-empty-after]) {\n\t\tvertical-align: bottom;\n\t}\n\n\t[ps-row=table-row] > *[ps-breaked-after][ps-breaked-before] {\n\t\tvertical-align: middle;\n\t}\n\n\t/* Font kerning is disabled to avoid invalid leader position on pdf rendering */\n\t[ps-has-leader] {\n\t\tfont-kerning: none;\n\t}\n\n\tps-leader {\n\t\t-moz-user-select: none;\n\t\t-ms-user-select: none;\n\t\t-webkit-user-select: none;\n\t\tdirection: rtl;\n\t\ttext-align: right;\n\t\twhite-space: pre;\n\t\tdisplay: inline-block;\n\t\tposition: relative;\n\t}\n\n\tps-leader[ps-direction=ltr] {\n\t\tdirection: ltr;\n\t\ttext-align: left;\n\t}\n\n\tps-leader-end {\n\t\tvisibility: hidden;\n\t}\n\n\t[ps-columns] {\n\t}\n\n\tps-columns {\n\t\tdisplay: flex;\n\t}\n\n\tps-column {\n\t\tdisplay: flex;\n\t\tflex-direction: column;\n\t\tflex: 1;\n\t\tmin-width: 0;\n\t}\n\n\tps-column-body {\n\t\tdisplay: block;\n\t}\n\n\tps-column > ps-column-body {\n\t\tflex: 1 1 0;\n\t\tmin-height: 0;\n\t}\n\n\tps-column-gap {\n\t\tmargin: 0 calc(var(--ps-gap) / 2);\n\t\tposition: relative;\n\t}\n\n\tps-column-rule {\n\t\tposition: absolute;\n\t\ttop: 0;\n\t\tbottom: 0;\n\t\tborder-left: var(--ps-rule);\n\t\tleft: 50%;\n\t\ttransform: translate(-50%, 0);\n\t}\n\n\n\tps-columns[ps-process=ended] > ps-column > ps-column-body {\n\t\tmin-height: auto;\n\t}\n\n\t/* TODO Chrome bug report? The display property of noscript tags is 'inline' */\n\tnoscript {\n\t\tdisplay: none;\n\t}\n\n\t/* Decoration are cloned by default on cells in the case of a repeated thead */\n\ttd::backdrop {\n\t\t--ps-box-decoration-break: clone;\n\t}\n\t\n\t[ps-baseline-loc] {\n\t\tall: initial !important;\n\t}\n`});
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.FlowIterator=exports.flowPredicate=void 0;const util_1=require("./util"),css_1=require("./css");exports.flowPredicate=util_1.walk.predicate(util_1.walk.isHTMLOrSVGRootSVGElement,util_1.walk.isStatic,util_1.walk.displayAsBlock);class FlowIterator{constructor(e,t,s=0,r){this.resetOnNext=!1,this.columnSpanBreak="element",this.elements=util_1.walk.createWalker(e,exports.flowPredicate),this.remaining=e.ownerDocument.createRange(),this.forcedBreakTypes=t,this.nextBreakType=r,this.nextPageGroupStart=!1,this.maxTextLength=s;let a=e;for(this.rootPageName="auto";a&&"auto"==this.rootPageName;)this.rootPageName=css_1.getCustomProp(a,"page"),a=a.parentElement;"auto"==this.rootPageName&&(this.rootPageName=""),this.reset()}[Symbol.iterator](){const e=this;return{next:function(){const t=e.next();return{done:!t,value:t}}}}reset(){this.elements.currentNode=this.elements.root,this.elements.nextNode(),this.remaining.selectNodeContents(this.elements.root),this.pageNames=[this.rootPageName]}next(){this.resetOnNext&&(this.reset(),this.resetOnNext=!1);let e=0;if(this.remaining.collapsed)return null;let t=null;const s={range:null,pageName:null,pageGroupStart:this.nextPageGroupStart,breakType:this.nextBreakType,maxTextLength:!1};this.nextBreakType=null,this.nextPageGroupStart=!1;const r=this.elements.currentNode;let a=r,n=!1;for(;!s.range;){const i=this.elements.currentNode,o=css_1.getCustomStyle(i),l=css_1.getCustomProp(o,"page");let u=!1,h=l;"auto"==h?h=this.pageNames[this.pageNames.length-1]:u=h!=s.pageName,this.pageNames.push(h),i instanceof HTMLTableElement&&(n=!0);const c="all"==css_1.getCustomProp(o,"column-span"),g=c?"-ps-column-span":css_1.getCustomProp(i,"break-before");if(i==r||a==r&&!util_1.walk.previousSibling(i,util_1.walk.isStaticNode))s.pageName=h,g&&this.forcedBreakTypes.includes(g)&&(s.breakType=g),!s.pageGroupStart&&u&&"auto"!=l&&(s.pageGroupStart=!0);else{const e=this.forcedBreakTypes.includes(g)&&g,r=c&&"element"==this.columnSpanBreak;if(e||t||u){this.nextBreakType=e||t,this.nextPageGroupStart=u||(e||t)&&"auto"!=l,s.range=util_1.ranges.breakRangeBefore(this.remaining,r?i:a),t=null,this.pageNames.pop();break}}if(!this.elements.firstChild()){if(this.pageNames.pop(),this.maxTextLength&&i instanceof HTMLElement&&(e+=i.innerText.length)>this.maxTextLength&&!n&&(s.range=util_1.ranges.breakRangeAfter(this.remaining,this.elements.currentNode),s.maxTextLength=!0,this.resetOnNext=!0),!s.range){const e=this._checkBreakAfter(i,s,o);!s.range&&e&&(t=e)}if(!s.range)for(;!this.elements.nextSibling();){if(this.pageNames.pop(),this.elements.currentNode.parentNode instanceof HTMLTableElement&&(n=!1),!this.elements.parentNode()||this.elements.currentNode==this.elements.root){s.range=util_1.ranges.breakRangeAfter(this.remaining,this.elements.root.lastChild);break}if(!t){const e=this._checkBreakAfter(this.elements.currentNode,s);if(s.range)break;e&&(t=e)}}a=this.elements.currentNode}}return s}_checkBreakAfter(e,t,s){s||(s=css_1.getCustomStyle(e));const r="all"==css_1.getCustomProp(s,"column-span"),a=r?"column":css_1.getCustomProp(s,"break-after");if(this.forcedBreakTypes.includes(a)||this.forcedBreakTypes.includes("column")&&r){const s=util_1.walk.nextSibling(e,util_1.walk.isStaticNode);return s&&!util_1.walk.displayAsBlock(s)?(t.range=util_1.ranges.breakRangeAfter(this.remaining,e),this.resetOnNext=!0,null):a}return null}}exports.FlowIterator=FlowIterator;

},{"./css":4,"./util":20}],8:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.cleanupAreas=exports.createAreas=exports.Fragmentor=exports.Fragment=void 0;const util_1=require("./util"),css_1=require("./css"),rows_1=require("./rows"),layout_1=require("./layout"),mutations_1=require("./mutations");class Fragment{}exports.Fragment=Fragment;class Fragmentor extends layout_1.LayoutProcessor{constructor(t,e){super(t,e),this.fragments=[],this.currentFragment=null,this.fragmentStartMut=new mutations_1.default,this.imagesToLoad=new Set,this.logNoValidBreakPoint=!0,this.dest=this.options.dest,this.dest||(this.dest=t.parentElement),this.options.plugins&&this.options.plugins.forEach(t=>this.use(t)),this.addSubProcessor(rows_1.trWithRowSpanSubFragmentor),this.addSubProcessor(rows_1.rowSubFragmentor)}onFragmentStart(t,e){discardMarginBreakBefore(t.body,e,this.fragmentStartMut),this.addImagesToLoad(t)}onFragmentBreak(t){this.setLastBreakedHeight(t.body)}setLastBreakedHeight(t){let e=t,a=null;const s=util_1.walk.predicate(util_1.walk.isHTMLElement,util_1.walk.isStatic,util_1.walk.displayAsBlock,util_1.walk.isBreakedAfter);for(;e&&e.hasAttribute("ps-breaked-after");)"fill"==css_1.getCustomProp(e,"box-remaining-extent")&&(a=e),e=util_1.walk.isRow(getComputedStyle(e))?util_1.walk.firstChild(e,s):util_1.walk.lastChild(e,util_1.walk.isStaticHtmlBlock);if(a&&a!=t){const t=this.layoutContext.bottomOffsets.get(a);if(t){const e=this.layoutContext.bodyBottom-t.after-t.currentMargin,s=util_1.rects.boundingScrollRect(a).bottom,r=parseFloat(getComputedStyle(a).height)+(e-s)+"px";this.layoutContext.mutations.setStyle(a,{height:r+"px"})}}}addImagesToLoad(t){css_1.addStyleImagesToLoad(t.container,this.imagesToLoad),t.area&&css_1.addStyleImagesToLoad(t.area,this.imagesToLoad);for(const e in t.areas)css_1.addStyleImagesToLoad(t.areas[e],this.imagesToLoad)}}function createAreas(t,e){const a=t.container.ownerDocument;if(t.areas={},e||(e=css_1.getCustomProp(t.container,"areas")),"auto"==e)return;const s=e.split(" ");for(const e of s){const s=a.createElement("ps-area");s.setAttribute("ps-name",e),t.areas[e]=(t.area||t.container).appendChild(s)}}function cleanupAreas(t){for(const e in t.areas){const a=t.areas[e];a.firstChild||a.remove()}}function discardMarginBreakBefore(t,e,a){const s=getComputedStyle(t);if("none"!=s.float)return;const r=css_1.getCustomProp(t,"margin-break");if((r.startsWith("discard")||r.startsWith("auto")&&!e)&&a.setAttr(t,"ps-margin-break-before","discard"),!parseFloat(s.borderTop)&&!parseFloat(s.paddingTop))if(util_1.walk.isRow(s))for(let s=util_1.walk.firstChild(t,util_1.walk.isStaticHtmlElement);s;s=util_1.walk.nextSibling(s,util_1.walk.isStaticHtmlElement))discardMarginBreakBefore(s,e,a);else{const s=util_1.walk.firstChild(t,util_1.walk.isStaticNode);util_1.walk.isHTMLElement(s)&&discardMarginBreakBefore(s,e,a)}}exports.Fragmentor=Fragmentor,Fragmentor.defaultOptions=Object.assign(Object.create(layout_1.LayoutProcessor.defaultOptions),{dest:null,authorCSS:!0,coreCSS:!0,defaultCSS:!0,preprocessCSS:!0,css:[],defaultPageSize:["21cm","29.7cm"],mediaType:"print"}),exports.createAreas=createAreas,exports.cleanupAreas=cleanupAreas;

},{"./css":4,"./layout":12,"./mutations":13,"./rows":18,"./util":20}],9:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.isFloatCall=exports.setLeaders=exports.setTargetCounters=exports.setPageTargetCounters=exports.setMarginContents=exports.setBookmarkLabels=exports.createBookmarks=exports.parsePseudosVals=exports.prepareGcpm=exports.GCPMContext=exports.PageMarginContent=exports.PSEUDOS=exports.VERTICAL_MARGIN_BOXES=exports.HORIZONTAL_MARGIN_BOXES=exports.CORNERS=exports.SIDES=void 0;const valueParser=require("postcss-value-parser"),util_1=require("./util"),css_1=require("./css"),counters_1=require("./counters");exports.SIDES=["top","right","bottom","left"],exports.CORNERS=["top-left-corner","top-right-corner","bottom-right-corner","bottom-left-corner"],exports.HORIZONTAL_MARGIN_BOXES=["left","center","right"],exports.VERTICAL_MARGIN_BOXES=["top","middle","bottom"],exports.PSEUDOS=["before","after","marker"];class InvalidArgCountError extends TypeError{constructor(e,t,n){super(`Failed to parse '${e}(${valueParser.stringify(t)}): ${n} argument${n>1?"s":""} required.`)}}class PageMarginContent{constructor(){this.start={},this.first={},this.last={}}}exports.PageMarginContent=PageMarginContent;class GCPMContext{constructor(){this.floats=new Map,this.pendingFloats=[],this.leaders=new Map,this.stringSets={},this.pageStringSets=new PageMarginContent,this.runnings={},this.pageRunnings=new PageMarginContent,this.bookmarks=new Set,this.targetCounters={}}}function prepareGcpm(e,t,n){if(util_1.walk.isHTMLElement(e)){"clone"==css_1.getCustomProp(t,"box-decoration-break")&&e.setAttribute("ps-box-decoration-break","clone"),css_1.getCustomProp(t,"margin-break").endsWith("keep")&&e.setAttribute("ps-margin-break-after","keep");const r=css_1.getCustomProp(t,"bookmark-level");"none"!=r&&r&&n.bookmarks.add(e);const s=css_1.getCustomProp(t,"position");if(s){const t=valueParser(s).nodes[0];"function"==t.type&&"running"==t.value&&e.setAttribute("ps-running",t.nodes[0].value)}for(const t of exports.PSEUDOS)parsePseudosVals(e,t,n)}if(util_1.walk.isHTMLOrSVGRootSVGElement(e)){const r=css_1.getCustomProp(t,"float");if(r){const s=valueParser(r).nodes[0];if("function"==s.type&&"-ps-area"==s.value){const r=e.ownerDocument,o=s.nodes[0].value,l=r.createElement("a");l.setAttribute("ps-float-call","");const a=e.cloneNode(!0);a.setAttribute("ps-float",o),a.setAttribute("ps-float-display",css_1.getCustomProp(t,"float-display")),e.removeAttribute("id"),e.setAttribute("ps-float-base",""),e.parentNode.insertBefore(l,e.nextSibling),l.setAttribute("href","#"+util_1.dom.id(a)),l.setAttribute("ps-float-area",o);const i=s.nodes.length>2?s.nodes[2].value:"auto";n.floats.set(e,{base:e,body:a,call:l,areaName:o,alignment:i})}}}}function parsePseudosVals(e,t,n){const r=getComputedStyle(e,"::"+t).getPropertyValue(`--ps-${t}-vals`).trim();if(r){const s=valueParser(r).nodes.filter(e=>"function"==e.type);for(let r=0;r<s.length;r++){const o=`--ps-${t}-val-${r}`;if(!e.style.getPropertyValue(o)){const l=[s[r]];parseContentVals(l,{element:e,pseudo:t,varName:o,srcElement:e,ctx:n}),e.style.setProperty(o,valueParser.stringify(l))}}}}function parseContentVals(e,t){valueParser.walk(e,(e,n,r)=>{if("function"==e.type){let s;const o=e.nodes.filter(e=>"div"!=e.type);if("attr"==e.value?s=fnAttr:"url"==e.value?s=fnUrl:"string"==e.value?s=fnString:"element"==e.value?s=fnElement:"leader"==e.value?s=fnLeader:"target-content"==e.value||"target-text"==e.value?s=fnTargetContent:"target-counter"==e.value&&(s=fnTargetCounter),s){const e=s(o,t);"string"==typeof e?r[n]={type:"string",value:e,quote:'"'}:Array.isArray(e)?r[n]={nodes:e}:r[n]=e}}},!0)}function parseStringSetVals(e,t){valueParser.walk(e,(e,n,r)=>{if("function"==e.type){let s;const o=e.nodes.filter(e=>"div"!=e.type);if("attr"==e.value?s=fnAttr:"url"==e.value?s=fnUrl:"counter"!=e.value&&"content"!=e.value||(e.value=`target-${e.value}`,e.nodes.unshift({type:"string",value:"#"+util_1.dom.id(t.element),quote:'"'},{type:"div",value:","})),s){const e=s(o,t);"string"==typeof e?r[n]={type:"string",value:e,quote:'"'}:Array.isArray(e)&&(r[n]={nodes:e})}}},!0)}function fnAttr(e,{srcElement:t}){if(e.length<1)throw new InvalidArgCountError("attr",e,1);const n=e[0].value;return t.hasAttribute(n)?t.getAttribute(n):(util_1.logger.warn(`Invalid attr() content function call : the attribute '${n}' does not exist.`),"")}function fnUrl(e){if(e.length<1)throw new InvalidArgCountError("url",e,1);return e[0].value}function fnString(e,{srcElement:t,ctx:n}){if(e.length<1)throw new InvalidArgCountError("string",e,1);const r=e[0].value,s=e.length>1?e[1].value:"first";let o="";"first"==s?o=n.pageStringSets.first[r]||n.stringSets[r]||"":"start"==s?o=n.pageStringSets.start[r]||n.stringSets[r]||"":"last"==s?o=n.pageStringSets.last[r]||n.stringSets[r]||"":"first-except"==s&&(o=n.pageStringSets.first[r]?"":n.stringSets[r]||"");const l=valueParser(o).nodes;return parseContentVals(l,{element:t,srcElement:t,ctx:n}),l}function fnElement(e,{srcElement:t,ctx:n}){if(e.length<1)throw new InvalidArgCountError("element",e,1);const r=e[0].value,s=e.length>1?e[1].value:"first";let o;if("first"==s?o=n.pageRunnings.first[r]||n.runnings[r]:"start"==s?o=n.pageRunnings.start[r]||n.runnings[r]:"last"==s?o=n.pageRunnings.last[r]||n.runnings[r]:"first-except"==s&&(o=n.pageRunnings.first[r]?null:n.runnings[r]),o){t.appendChild(o.cloneNode(!0)).removeAttribute("ps-running")}return""}function fnLeader(e,{element:t,pseudo:n,ctx:r}){if(e.length<1)throw new InvalidArgCountError("leader",e,1);const s=e[0];let o;"word"==s.type?"dotted"==s.value?o=". ":"solid"==s.value?o="_":"space"==s.value&&(o=" "):"string"==s.type&&(o=s.value);const l={pseudo:n,pattern:o,element:t.ownerDocument.createElement("ps-leader")};return"after"==n?t.appendChild(l.element):t.insertBefore(l.element,t.firstChild),l.element.textContent=l.pattern,l.element.setAttribute("ps-position",n),l.element.setAttribute("ps-direction","ltr"==getComputedStyle(t).direction?"rtl":"ltr"),r.leaders.set(t,l),""}function fnTargetCounter(e,{element:t,srcElement:n,ctx:r,varName:s}){if(e.length<2)throw new InvalidArgCountError("target-counter",e,2);const o=checkTarget(e[0].value,!1);if(!o)return"";const l=e[1].value;let a=r.targetCounters[o];a||(a=r.targetCounters[o]={});let i=s;if(!i){const e=getComputedStyle(t);let n=0;for(i=`--ps-target-counter-${n}`;e.getPropertyValue(i);)i=`--ps-target-counter-${++n}`}let u=a[l];return u||(u=a[l]=[]),u.push({element:t,varName:i}),s?"000":valueParser(`var(${i}, "000")`).nodes[0]}function fnTargetContent(e,{srcElement:t,ctx:n}){if(e.length<1)throw new InvalidArgCountError("target-content",e,1);const r=checkTarget(e[0].value);if(!r)return"";const s=t.ownerDocument.getElementById(r);if(!s)return"";const o=e.length>1?e[1].value:"text";if("text"==o)return s.textContent.trim();if("first-letter"==o)return s.textContent.trim().substr(0,1);if("before"==o||"after"==o||"marker"==o){const e=getComputedStyle(s,o).content,r=valueParser(e).nodes;return parseStringSetVals(r,{element:s,srcElement:s,ctx:n}),parseContentVals(r,{element:t,srcElement:s,ctx:n}),r}}function createBookmarks(e,t){const n=e.createElement("ps-bookmarks"),r=e.createElement("ol"),s=[r];for(const n of t.bookmarks){const r=css_1.getCustomStyle(n),o=parseInt(css_1.getCustomProp(r,"bookmark-level"));if(!isNaN(o)&&util_1.walk.hasSize(n)){const l=css_1.getCustomProp(r,"bookmark-label"),a=valueParser(l).nodes,i=e.createElement("li"),u=i.appendChild(e.createElement("a"));u.href="#"+util_1.dom.id(n),parseStringSetVals(a,{element:n,srcElement:n,ctx:t}),parseContentVals(a,{element:u,srcElement:n,ctx:t});const c=valueParser.stringify(a);u.style.setProperty("--ps-label",c);const g=e.createElement("ol");let p;g.setAttribute("ps-state",css_1.getCustomProp(r,"bookmark-state")),i.appendChild(g);for(let e=0;e<o;e++)s[e]?p=s[e]:s.push(void 0);p.appendChild(i);for(let e=o;e<s.length;e++){const t=s[e];t&&!t.firstChild&&t.remove()}s.length=o,s.push(g)}}for(const e of s)e&&!e.firstChild&&e.remove();return r.firstChild&&n.appendChild(r),n}function setBookmarkLabels(e){const t=util_1.walk.createIterator(e,util_1.walk.isConstructedBy(HTMLAnchorElement),util_1.walk.isElement);let n;for(;n=t.nextNode();){const e=valueParser(getComputedStyle(n).getPropertyValue("--ps-label")).nodes;n.textContent=e.filter(e=>"string"==e.type).map(e=>e.value).join(""),n.removeAttribute("style")}}function setMarginContents(e,t){const n=util_1.walk.createWalker(e.body,util_1.walk.isHTMLElement),r=new Map,s=new Map;do{const e=css_1.getCustomStyle(n.currentNode),t=css_1.getCustomProp(e,"string-set").trim();t&&"none"!=t&&r.set(n.currentNode,t);const o=css_1.getCustomProp(e,"position");o.startsWith("running(")&&s.set(n.currentNode,o)}while(n.nextNode());t.pageStringSets={start:{},first:{},last:{}};for(const[s,o]of r){const r=valueParser(o).nodes;let l=0;for(;l<r.length;){const o=r[l++].value,a=l;for(;l<r.length&&"div"!=r[l].type&&","!=r[l].value;)l++;const i=r.slice(a,l);parseStringSetVals(i,{element:s,srcElement:s,ctx:t});const u=valueParser.stringify(i);n.currentNode=s;const c=n.previousNode();c&&c!=e.body||(t.pageStringSets.start[o]=u),void 0===t.pageStringSets.first[o]&&(t.pageStringSets.first[o]=u),t.pageStringSets.last[o]=u,l++}}t.pageRunnings={start:{},first:{},last:{}};for(const[r,o]of s){const s=valueParser(o).nodes[0].nodes[0].value;n.currentNode=r;const l=n.previousNode();l&&l!=e.body||(t.pageRunnings.start[s]=r),void 0===t.pageRunnings.first[s]&&(t.pageRunnings.first[s]=r),t.pageRunnings.last[s]=r}const o={};for(const n in e.marginBoxes){const r=e.marginBoxes[n];"none"!=getComputedStyle(r,"::before").content&&(parsePseudosVals(r,"before",t),o[n]=!0)}for(const e in t.pageStringSets.last)t.stringSets[e]=t.pageStringSets.last[e];for(const e in t.pageRunnings.last)t.runnings[e]=t.pageRunnings.last[e];function l(t){e.marginBoxes[t].remove(),e.marginBoxes[t]=null}for(let e,t=0;exports.SIDES.length,e=exports.SIDES[t];t++)if(o[exports.CORNERS[t]]||l(exports.CORNERS[t]),t%2==0){const t=e+"-left",n=e+"-right";o[t]||o[n]||(l(t),l(n))}else{const t=e+"-top",n=e+"-bottom";o[t]||o[n]||(l(t),l(n))}for(let t,n=0;exports.SIDES.length,t=exports.SIDES[n];n++)if(n%2==0){const n=t+"-center",r=t+"-left",s=t+"-right";o[n]||(l(n),e.marginBoxes[r]&&!o[r]&&l(r),e.marginBoxes[s]&&!o[s]&&l(s))}else{const n=t+"-middle";if(!o[n]){l(n);const r=t+"-top",s=t+"-bottom";e.marginBoxes[r]&&!o[r]&&l(r),e.marginBoxes[s]&&!o[s]&&l(s)}}for(let t,n=0;exports.SIDES.length,t=exports.SIDES[n];n++){(n%2==0?exports.HORIZONTAL_MARGIN_BOXES:exports.VERTICAL_MARGIN_BOXES).every(n=>!e.marginBoxes[t+"-"+n])&&e.container.querySelector(`ps-margin[ps-side=${t}]`).remove()}for(let t,n=0;exports.SIDES.length,t=exports.SIDES[n];n++)if(n%2==0){const n=e.marginBoxes[t+"-center"];if(n){const r=e.marginBoxes[t+"-left"],s=e.marginBoxes[t+"-right"];if(r&&s){r.clientWidth!=s.clientWidth&&(n.style.maxWidth=n.clientWidth+"px",r.style.flexBasis=s.style.flexBasis="0")}}}else{const n=e.marginBoxes[t+"-middle"];if(n){const r=e.marginBoxes[t+"-top"],s=e.marginBoxes[t+"-bottom"];if(r&&s){r.clientHeight!=s.clientHeight&&(n.style.maxHeight=n.clientHeight+"px",r.style.flexBasis=s.style.flexBasis="0")}}}}function setPageTargetCounters(e,t,n){for(const t in n.targetCounters){if(e.body.querySelector("#"+t)){const r=n.targetCounters[t];for(const t in r)if("page"==t){const n=valueParser.stringify({type:"string",value:e.number.toString(),quote:'"'});for(const e of r[t])e.element.style.setProperty(e.varName,n);delete r[t]}Object.keys(r).length||delete n.targetCounters[t]}}}function setTargetCounters(e,t){for(const n in t.targetCounters){const r=document.getElementById(n),s=t.targetCounters[n];for(const t in s){let n;n=r?"pages"==t?e.length:"page"==t?counters_1.getPageCounterValue(e,r):counters_1.getCounterValue(r,t):"";const o=valueParser.stringify({type:"string",value:n.toString(),quote:'"'});for(const e of s[t])e.element.style.setProperty(e.varName,o)}}}function setLeaders(e){if(e.leaders&&e.leaders.size)for(const[t,n]of e.leaders.entries())if(t.offsetHeight){let e=t,r=getComputedStyle(e);for(;!util_1.walk.displayAsBlockStyle(r);)e=e.parentNode,r=getComputedStyle(e);e.setAttribute("ps-has-leader","");const s=util_1.rects.boundingScrollRect(e),o=r.textAlign;let l=o;"justify"==o&&(e.style.textAlign="start",l=e.style.textAlign);let a=util_1.rects.boundingScrollRect(n.element);const i=a.width;n.element.textContent="",a=util_1.rects.boundingScrollRect(n.element);const u="ltr"==r.direction;let[c,g]=getLeaderStartEnd(e,s,n,a,u,l),p=g-parseFloat(u?r.paddingRight:r.paddingLeft);if(p<.1){n.element.parentNode.insertBefore(document.createElement("br"),n.element),a=util_1.rects.boundingScrollRect(n.element);const[t,o]=getLeaderStartEnd(e,s,n,a,u,l),i=o-parseFloat(u?r.paddingRight:r.paddingLeft);i<.1?(n.element.previousElementSibling.remove(),a=util_1.rects.boundingScrollRect(n.element)):(c=t,g=o,p=i)}const f=s.width-g-c;n.element.style.width=Math.floor(10*f)/10-1+"px";const d=n.element.appendChild(document.createElement("ps-leader-end"));"ltr"==r.direction?d.style.marginRight=-p+"px":d.style.marginLeft=-p+"px";let m="",x=p/i;x/Math.floor(x)<1.01&&x--;for(let e=0;e<x;e++)m+=n.pattern;d.textContent=m;let h="";const v=Math.floor(f/i);for(let e=0;e<v;e++)h+=n.pattern;n.element.appendChild(document.createTextNode(h)),n.element.scrollWidth>n.element.clientWidth&&(n.element.lastChild.nodeValue=h.slice(0,-1)),"justify"==o&&(e.style.textAlign="")}}function getLeaderStartEnd(e,t,n,r,s,o){const l=s?r.left-t.left:t.right-r.right;"start"==o?e.style.textAlign="end":"end"==o?e.style.textAlign="start":"left"==o?e.style.textAlign="right":o&&(e.style.textAlign="left");const a=util_1.rects.boundingScrollRect(n.element),i=s?t.right-a.right:a.left-t.left;return e.style.textAlign=o,[l,i]}function checkTarget(e,t=!0){const n=e.split("#");return n[0]&&n[0]!==document.baseURI?(util_1.logger.warn("Invalid target-counter() content function call : the url does not correspond to the document."),null):n.length<2||!n[1]?(util_1.logger.warn("Invalid target-counter() content function call : the url fragment is empty."),null):t&&!document.getElementById(n[1])?(util_1.logger.warn("Invalid target-counter() content function call : the target does not exist."),null):n[1]}function isFloatCall(e){return"a"==e.localName&&e.hasAttribute("ps-float-call")}exports.GCPMContext=GCPMContext,exports.prepareGcpm=prepareGcpm,exports.parsePseudosVals=parsePseudosVals,exports.createBookmarks=createBookmarks,exports.setBookmarkLabels=setBookmarkLabels,exports.setMarginContents=setMarginContents,exports.setPageTargetCounters=setPageTargetCounters,exports.setTargetCounters=setTargetCounters,exports.setLeaders=setLeaders,exports.isFloatCall=isFloatCall;

},{"./counters":3,"./css":4,"./util":20,"postcss-value-parser":32}],10:[function(require,module,exports){
...
},{"./postscriptum":15}],12:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.isSubFragmentor=exports.removeFloats=exports.moveFloat=exports.testAvoidBreakInside=exports.testLinesOverflow=exports.testInlineOverflow=exports.testBoxOverflow=exports.updateBottomOffsets=exports.LayoutProcessor=exports.LayoutContext=exports.Box=void 0;const gcpm_1=require("./gcpm"),process_1=require("./process"),util_1=require("./util"),breaks_1=require("./breaks"),shim_1=require("./shim"),css_1=require("./css"),valueParser=require("postcss-value-parser"),mutations_1=require("./mutations");class Box{constructor(){this.range=new Range,this.avoidBreakBefore=!1,this.avoidBreakAfter=!1,this.hasInlineBlocks=!1}}exports.Box=Box;class LayoutContext extends util_1.events.EventEmitter{constructor(t,e,o,n){super(),this.boxes=[],this.floats=[],this.overflowPoint=null,this.overflowBox=null,this.mutations=new mutations_1.default,this.root=t,this.body=e,this.areas=o,this.parentCtx=n,this.bottomOffsets=this.parentCtx?this.parentCtx.bottomOffsets:new Map}get bodyBottom(){return this._bodyBottom||(this._bodyBottom=util_1.rects.boundingScrollRect(this.body).bottom),this._bodyBottom}set bodyBottom(t){if(t!=this._bodyBottom){const e=this._bodyBottom;this._bodyBottom=t,this.emit({type:"body-bottom-change",oldBottom:e,newBottom:this._bodyBottom})}}}exports.LayoutContext=LayoutContext;class LayoutProcessor extends process_1.Processor{constructor(t,e){super(e),this.subProcessors=[],this.gcpmContext=new gcpm_1.GCPMContext,this.layoutContext=null,this.avoidBreakTypes=["avoid"],this.logNoValidBreakPoint=!1,this.source=t,this.doc=this.source.ownerDocument,shim_1.default(this.source.ownerDocument.defaultView)}get mutations(){return util_1.logger.debug("LayoutProcessor.mutations deprecated. Please use LayoutContext.mutations"),this.layoutContext&&this.layoutContext.mutations}addSubProcessor(t){return this.subProcessors.push(t),this}*contentsProcess(t,e,o){this.listenerCount("contents-start")&&(yield{type:"contents-start"});let n,r,i="detect-overflow",s=null;do{if("detect-overflow"==i){if(s=this.layoutContext=this.createLayoutContext(t,e,o),this.gcpmContext.pendingFloats.length){const t=this.gcpmContext.pendingFloats.splice(0);for(const e of t)moveFloat(e,this.layoutContext,this.gcpmContext)}yield*this.boxesProcess(t),"breakPoint"in s?(n="valid-break-point",r="break-point-found"):s.overflowPoint?(s.breakPoint=util_1.ranges.clonePoint(s.overflowPoint),s.breakedBox=s.overflowBox,r="validate-break-point",n="overflow-detected"):(s.breakPoint=util_1.ranges.positionAfter(t.lastChild),s.breakedBox=null,n="no-overflow",r="break-point-found")}else if("validate-break-point"==i){const t=validBreakPoint(s,this.avoidBreakTypes);if("boolean"!=typeof t&&util_1.ranges.pointEquals(t.breakPoint,s.breakPoint))throw new Error("Loop on break point validation");if(t)!0===t?(r="break-point-found",n="valid-break-point"):(s.breakPoint=t.breakPoint,s.breakedBox=t.breakedBox,removeFloats(s.floats,s.breakPoint),n="new-break-point-to-valid",r="validate-break-point");else{r="no-break-point",n="no-break-point";const t=s.boxes[s.boxes.length-1],e=s.boxes.findIndex(t=>!t.isRepeated);s.boxes.length-1>e?(s.breakPoint=util_1.ranges.rangeStart(t.range),s.breakedBox=t):(s.breakPoint=util_1.ranges.rangeEnd(t.range),s.breakedBox=null)}}else"no-break-point"==i&&(this.logNoValidBreakPoint&&util_1.logger.warn("No valid break point found."),r="break-point-found");(i=n&&this.listenerCount(n)?yield{type:n,layoutContext:s}:null)||(i=r)}while("break-point-found"!=i);return this.listenerCount("contents-end")&&(yield{type:"contents-end"}),n}*boxesProcess(t){const e=t.ownerDocument,o=this.layoutContext,n=o.bottomOffsets.has(t.parentElement)?[o.bottomOffsets.get(t.parentElement)]:[],r=updateBottomOffsets(n,getComputedStyle(t),css_1.getCustomStyle(t));o.bottomOffsets.set(t,r);const i=util_1.walk.createWalker(t,util_1.walk.isStaticNode);i.nextNode();let s=new Box;s.range.setStartBefore(t.firstChild);const l=new Set,a={layoutContext:o,nodes:i,areas:o.areas,currentElement:null,currentCustomStyle:null,currentStyle:null,currentBox:s},c=(t,e)=>{if(o.boxes.push(t),t.bottomOffset=e?n.pop():n[n.length-1],o.overflowPoint=testBoxOverflow(t,o.bodyBottom),t.floats&&t.floats.length)for(const e of t.floats)if(e&&!l.has(e.areaName)){!moveFloat(e,o,this.gcpmContext,t)&&l.add(e.areaName)}return o.overflowPoint&&(o.overflowBox=t),o.overflowPoint};function u(t){s=new Box,a.currentBox=s,s.range.setStartBefore(i.currentNode),t&&(s.startBlock=i.currentNode)}for(;;){let r=!1;if(i.currentNode.nodeType==Node.ELEMENT_NODE){let t=i.currentNode;if(a.currentElement=t,t.localName,gcpm_1.isFloatCall(t)){const e=this.gcpmContext.floats.get(t.previousElementSibling);s.floats||(s.floats=[]),s.floats.push(e),o.floats.push(e)}let e=a.currentStyle=getComputedStyle(t),l=a.currentCustomStyle=css_1.getCustomStyle(t);if(r=util_1.walk.displayAsBlockStyle(e)){s.startBlock||(s.startBlock=t),s.endBlock=t,s.mainBlock=t;const c=updateBottomOffsets(n,e,l);o.bottomOffsets.set(t,c),s.avoidBreakBefore||(s.avoidBreakBefore=this.avoidBreakTypes.includes(css_1.getCustomProp(l,"break-before"))),s.unbreakable||(s.unbreakable=breaks_1.unbreakableElement(t)),s.isRepeated||(s.isRepeated=t.hasAttribute("ps-repeated")),this.avoidBreakTypes.includes(css_1.getCustomProp(l,"break-inside"))||this.fixWidth(t,e,o);for(const t of this.subProcessors){let e=t.call(this,a);if(e){if(e instanceof Promise&&(e=yield e),s.unbreakable="subFragmentor",!e)break;if(e.breakPoint)return o.breakPoint=e.breakPoint,o.breakedBox=s,o;if(e.floats&&o.floats.push(...e.floats),e.overflowPoint)return o.overflowPoint=e.overflowPoint,o.overflowBox=s,o}}const u=i.currentNode;u!=t&&(t=u,l=css_1.getCustomStyle(t),e=getComputedStyle(t),(r=util_1.walk.displayAsBlockStyle(e))&&(s.endBlock=t)),s.avoidBreakAfter||(s.avoidBreakAfter=s.isRepeated||this.avoidBreakTypes.includes(css_1.getCustomProp(l,"break-after")))}}let l=!1;if(r||(s.inlinesRange||(s.inlinesRange=e.createRange(),s.inlinesRange.setStartBefore(i.currentNode),s.inlinesStartBoundary=!0),s.inlinesRange.setEndAfter(i.currentNode),util_1.walk.isInlineBlockElement(i.currentNode)&&(l=!0,s.hasInlineBlocks=!0)),"replacedElement"==s.unbreakable||"subFragmentor"==s.unbreakable||l||!i.firstChild()){for(;!i.nextSibling();){const e=i.parentNode();if(r=!e||util_1.walk.displayAsBlock(e),e&&!s.avoidBreakAfter&&(s.avoidBreakAfter=this.avoidBreakTypes.includes(css_1.getCustomProp(e,"break-after"))),i.currentNode==t)return s.range.setEndAfter(t.lastChild),c(s,r),o;s.endBlock=e}s.inlinesRange&&(s.inlinesStartBoundary=!1);const e=util_1.walk.displayAsBlock(i.currentNode);if(!r&&e&&(s.mainBlock=null),r||e){if(s.range.setEndBefore(i.currentNode),c(s,r))return o;u(e)}}else if(!r&&!s.inlinesStartBoundary&&util_1.walk.displayAsBlock(i.currentNode)){if(s.mainBlock=s.endBlock=null,s.range.setEndBefore(i.currentNode),s.inlinesRange.setEndBefore(i.currentNode),c(s,r))return o;u(!0)}}return o}createLayoutContext(t,e,o){return new LayoutContext(t,t,e,o)}fixWidth(t,e,o){if(t.hasAttribute("ps-fixed-width"))return;let n=!1;if(t instanceof HTMLTableElement){const r=t.caption==t.firstElementChild&&t.caption;let i=r?r.nextElementSibling:t.firstElementChild;const s=Array.from(t.rows[0].cells).reduce((t,e)=>t+e.colSpan,0),l=new Map;if("colgroup"==i.localName){if(s!=i.children.length)return void util_1.logger.warn("Invalid colgroup/col count. The width of the table cannot be fixed.");for(let t=0;t<s;t++){const e=i.children.item(t).style.width;e&&!e.endsWith("%")||l.set(t,-1)}}else{i=this.doc.createElement("colgroup"),t.insertBefore(i,r.nextElementSibling||t.firstElementChild);for(let t=0;t<s;t++)i.appendChild(this.doc.createElement("col")),l.set(t,-1);o.mutations.push({colgroup:i,revert(){this.colgroup.remove()}})}let a=l.size;if(a){for(const e of t.rows){for(let t=0,o=0;t<e.cells.length&&a;t++){const n=e.cells[t];1==n.colSpan&&-1==l.get(o)&&(l.set(o,n.getBoundingClientRect().width),a--),o+=n.colSpan}if(!a)break}for(let t=0;t<s;t++){const e=l.get(t);if(-1!=e){const n=i.children.item(t);o.mutations.setStyle(n,{width:e+"px"})}}}o.mutations.setStyle(t,{"min-width":e.width}),n=!0}else if("tr"!=t.localName&&util_1.walk.isRow(e)){const e=new Map;for(const o of t.children)util_1.walk.isStatic(o)&&e.set(o,getComputedStyle(o).width);for(const[t,n]of e)o.mutations.setStyle(t,{width:n});n=!0}n&&o.mutations.setAttr(t,"ps-fixed-width")}}function updateBottomOffsets(t,e,o){const n=t[t.length-1],r=css_1.getCustomProp(o,"box-decoration-break"),{inside:i,currentMargin:s}=n||{inside:0,currentMargin:0};let l={after:i,inside:i,currentMargin:0};"keep"==css_1.getCustomProp(o,"margin-break")&&(l.currentMargin=Math.max(parseFloat(e.marginBottom),s));let a=0;if("clone"==r&&(a+=parseFloat(e.paddingBottom),"none"!=e.borderBottomStyle&&(a+=parseFloat(e.borderBottomWidth),"table"==e.display&&"separate"==e.borderCollapse))){const t=parseFloat(e.borderSpacing.split(" ")[1]);t&&(a+=t)}return a&&(l.after+=l.currentMargin,l.inside+=a+l.currentMargin,l.currentMargin=0),n&&Object.keys(l).every(t=>l[t]==n[t])?l=n:Object.freeze(l),t.push(l),l}function validBreakPoint(t,e){const o=t.body.ownerDocument,n=t.body.ownerDocument.defaultView,r=util_1.ranges.findPointInRanges(t.boxes.map(t=>t.range),t.breakPoint,!0);if(-1==r)throw new Error("Box of the break point not found.");let i=t.boxes[r];function s(t){return{breakPoint:util_1.ranges.rangeStart(t.range),breakedBox:t}}const l=testAvoidBreakInside(t.breakPoint.container,t,e,t.breakPoint);if(l){const e=util_1.ranges.positionBefore(l),o=util_1.ranges.positionBefore(t.root);if(util_1.ranges.pointEquals(e,o)||util_1.ranges.isPrecedingPoint(o,e))return!1;const n=util_1.ranges.findPointInRanges(t.boxes.map(t=>t.range),e,!0);return s(t.boxes[n])}if(t.breakPoint.container==i.range.startContainer&&t.breakPoint.offset==i.range.startOffset){const e=r>0&&t.boxes[r-1];if(!e)return!1;if(!i.avoidBreakBefore&&!e.avoidBreakAfter)return!0;if(!e.inlinesRange)return s(e);i=e,t.breakPoint=util_1.ranges.rangeEnd(e.inlinesRange)}if(i.unbreakable)return s(i);if(!(i.inlinesRange&&i.inlinesRange.isPointInRange(t.breakPoint.container,t.breakPoint.offset)))return s(i);{if(0==t.breakPoint.offset&&util_1.walk.firstChild(i.inlinesRange.startContainer,util_1.walk.isStaticNode)==t.breakPoint.container)return s(i);const e=o.createRange();e.setStart(i.inlinesRange.startContainer,i.inlinesRange.startOffset),e.setEnd(t.breakPoint.container,t.breakPoint.offset);const r=getComputedStyle(i.inlinesRange.commonAncestorContainer),l=util_1.rects.rectsLines(e.getClientRects(),n);if(!l.length)return s(i);const a=parseInt(r.getPropertyValue("--ps-orphans"));if(l.length<a)return s(i);const c=parseInt(r.getPropertyValue("--ps-widows"));if(c>0){const e=o.createRange();e.setStart(t.breakPoint.container,t.breakPoint.offset),e.setEnd(i.inlinesRange.endContainer,i.inlinesRange.endOffset);const r=util_1.rects.rectsLines(e.getClientRects(),n),u=util_1.rects.rectsLines(i.inlinesRange.getClientRects(),n),d=c-r.length;if(d>0){const t=u.length-r.length-d;if(t<a)return s(i);{const e=u[t-1],o=getComputedStyle(i.mainBlock||util_1.walk.ancestorOrSelf(i.range.commonAncestorContainer,util_1.walk.isElement)).direction;return i.inlineStart="ltr"==o?Math.ceil(e.left):Math.floor(e.right),{breakPoint:testLinesOverflow(i,l,Math.ceil(e.bottom)),breakedBox:i}}}}}return!0}function testBoxOverflow(t,e){if(t.mainBlock||!t.inlinesRange){const e=util_1.rects.boundingScrollRect(t.startBlock);t.top=e.top,t.startBlock==t.endBlock?t.bottom=e.bottom:(t.bottom=util_1.rects.boundingScrollRect(t.endBlock).bottom,t.endBlock.contains(t.startBlock)&&e.bottom>t.bottom&&(t.bottom=e.bottom))}else t.inlinesRangeRect=util_1.rects.boundingScrollRect(t.inlinesRange),t.bottom=t.inlinesRangeRect.bottom,t.top=t.inlinesRangeRect.top;const o=e-t.bottomOffset.after-t.bottomOffset.currentMargin;if(t.bottom>o){let e=util_1.ranges.rangeStart(t.range);return!t.unbreakable&&t.inlinesRange&&o-t.top>=4&&(e=testInlineOverflow(t,o)),e}return null}function testInlineOverflow(t,e,o){if(o||(o=e-t.bottomOffset.inside-t.bottomOffset.currentMargin),t.inlinesRangeRect||(t.inlinesRangeRect=util_1.rects.boundingScrollRect(t.inlinesRange)),t.inlinesRangeRect.bottom<o)return util_1.ranges.rangeEnd(t.inlinesRange);if(!t.inlineStart){const e=getComputedStyle(t.mainBlock||util_1.walk.ancestorOrSelf(t.range.commonAncestorContainer,util_1.walk.isElement)).direction;t.inlineStart="ltr"==e?Math.ceil(t.inlinesRangeRect.left):Math.floor(t.inlinesRangeRect.right)}const n=util_1.rects.rectsLines(t.inlinesRange.getClientRects(),t.inlinesRange.startContainer.ownerDocument.defaultView);return n.length<=1?util_1.ranges.rangeStart(t.range):testLinesOverflow(t,n,o)}function testLinesOverflow(t,e,o){const n=t.range.commonAncestorContainer.ownerDocument;for(let r=0;r<=e.length;r++){const i=e[r];let s;if(r==e.length?s=e[r-1]:i.bottom>Math.ceil(o)&&(r===e.length-1||e[r+1].top>Math.ceil(o))&&(s=i),s){let e=util_1.ranges.textPositionFromPoint(n,t.inlineStart,Math.ceil(s.top)+2);if(!e)return util_1.ranges.rangeStart(t.range);if(util_1.ranges.containsPoint(t.inlinesRange,e)||(e=util_1.ranges.textPositionFromPoint(n,t.inlineStart,Math.ceil(s.top))),util_1.ranges.containsPoint(t.inlinesRange,e)){e.container.nodeType==Node.TEXT_NODE&&0==e.offset&&(e=util_1.ranges.positionBefore(e.container));const o=util_1.ranges.nodeAtPoint(e)||e.container;if(util_1.walk.isElement(o)&&gcpm_1.isFloatCall(o)&&(e=util_1.ranges.positionBefore(o.previousElementSibling)),t.hasInlineBlocks){let n=o;for(;n!=(t.mainBlock||t.range.commonAncestorContainer);){if(util_1.walk.displayAsInlineBlock(n)){e=util_1.ranges.positionBefore(n);break}n=n.parentElement}}return e}return util_1.logger.warn("Overflowing text position outside of the box inline range."),util_1.ranges.rangeStart(t.range)}}}function testAvoidBreakInside(t,e,o,n,r=!1){let i,s=t.nodeType==Node.TEXT_NODE?t.parentElement:t;function l(){if(!i){let t=e;for(;t.parentCtx;)t=t.parentCtx;i=t.body.getBoundingClientRect().height}return i}for(;s&&s!=e.body.parentNode;){if(util_1.walk.displayAsBlock(s)){const t=css_1.getCustomProp(s,"break-inside");if("auto"!=t){let e=o.includes(t)&&!s.hasAttribute("ps-breaked-before");if(!e){const o=valueParser(t).nodes[0];if("function"==o.type&&"-ps-avoid-if-below"==o.value){const t=css_1.computeLength(o.nodes[0].value,l());if(t&&s.scrollHeight-1<t&&(e=!0),!e&&n&&o.nodes.length>2){const t=css_1.computeLength(o.nodes[2].value,s.getBoundingClientRect().height);if(t)if(r){util_1.ranges.nodeAtPoint(n).getBoundingClientRect().top-s.getBoundingClientRect().top-1<t&&(e=!0),r=!1}else{const o=document.createRange();o.setStartBefore(s),o.setEnd(n.container,n.offset),o.getBoundingClientRect().height-1<t&&(e=!0)}}}}if(e)return s}}s=s.parentElement}return!1}function moveFloat(t,e,o,n){if(e.overflowPoint&&util_1.ranges.isPrecedingPoint(util_1.ranges.positionBefore(t.call),e.overflowPoint))return!1;let r=util_1.rects.boundingScrollRect(t.call);if(r.bottom>=e.bodyBottom)return!1;const i=e.areas[t.areaName];if(!i)return o.pendingFloats.push(t),!1;const s=layoutCtxFromArea(e,i);i.lastChild&&i.lastChild.nodeType!=Node.TEXT_NODE&&i.appendChild(document.createTextNode(" ")),i.appendChild(t.body);const l=util_1.rects.boundingScrollRect(i),a=s.body,c=util_1.rects.boundingScrollRect(a),u={floatBody:t.body,revert(){this.floatBody.remove(),this.floatBody.style.marginTop=""}},d=l.right<=c.left||l.left>=c.right;let f=t.alignment;"auto"==f&&(f=d?"baseline":"none");let g=util_1.rects.boundingScrollRect(t.body);if("none"!=f){if("baseline"==f){if(d){const e=document.createElement("img");e.setAttribute("ps-baseline-loc",""),t.body.insertBefore(e,t.body.firstChild);const o=util_1.rects.boundingScrollRect(e).bottom;t.call.parentElement.insertBefore(e,t.call.nextSibling);const n=util_1.rects.boundingScrollRect(e).bottom;e.remove(),o<n&&(t.body.style.marginTop=Math.max(n-o,0)+"px")}}else{let e=-1,o=-1;const n=util_1.walk.ancestor(t.call,util_1.walk.isBlockElement),i=util_1.rects.boundingScrollRect(n);if("block-start-edge"==f)d?e=i.top:o=i.left;else if("block-end-edge"==f)d?e=i.bottom-g.height:o=i.right-g.width;else if(d){const t=document.createRange();t.selectNodeContents(n);const o=util_1.rects.rectsLines(t.getClientRects(),window).find(t=>util_1.rects.includesRect(t,r));e="inline-start-edge"==f?o.top:o.bottom-g.height}else o="inline-start-edge"==f?r.left:r.right-g.width;-1!=e&&g.top<e?t.body.style.marginTop=Math.max(e-g.top,0)+"px":-1!=o&&g.left<o&&(t.body.style.marginLeft=Math.max(o-g.left,0)+"px")}g=util_1.rects.boundingScrollRect(t.body)}if(!util_1.rects.includesRect(l,g))return o.pendingFloats.push(t),u.revert(),!1;const p=util_1.rects.boundingScrollRect(a),b=e.emit({type:"float-move",float:t,area:i,areaBody:a,areaBodyRect:c,newAreaBodyRect:p});if("pending"==b&&o.pendingFloats.push(t),!1===b||"pending"==b)return u.revert(),!1;if(n){if(r.bottom>=p.bottom)return u.revert(),e.overflowPoint=testInlineOverflow(n,p.bottom,r.top),!1}else if(!p.height||!p.width)return u.revert(),!1;return s.bodyBottom!=p.bottom&&(s.bodyBottom=p.bottom),n&&(e.overflowPoint=testBoxOverflow(n,e.bodyBottom)),e.mutations.push(u),!0}function removeFloats(t,e){for(let o=t.length-1;o>=0;o--){const n=t[o];if(e&&!util_1.ranges.isPrecedingPoint(util_1.ranges.positionBefore(n.call),e))break;n.body.remove(),t.pop()}}function layoutCtxFromArea(t,e){let o=t;for(;o.body.parentElement!=e.parentElement;)o=o.parentCtx;return o}function isSubFragmentor(t){return"parentFragmentor"in t}exports.LayoutProcessor=LayoutProcessor,LayoutProcessor.defaultOptions=process_1.Processor.defaultOptions,exports.updateBottomOffsets=updateBottomOffsets,exports.testBoxOverflow=testBoxOverflow,exports.testInlineOverflow=testInlineOverflow,exports.testLinesOverflow=testLinesOverflow,exports.testAvoidBreakInside=testAvoidBreakInside,exports.moveFloat=moveFloat,exports.removeFloats=removeFloats,exports.isSubFragmentor=isSubFragmentor;

},{"./breaks":1,"./css":4,"./gcpm":9,"./mutations":13,"./process":17,"./shim":19,"./util":20,"postcss-value-parser":32}],13:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Mutations=void 0;const ranges_1=require("./util/ranges"),breaks_1=require("./breaks");class Mutations{constructor(){this._entries=[]}push(...e){this._entries.push(...e)}revert(){let e;for(;e=this._entries.pop();)e.revert()}commit(e){e&&e.push(...this._entries),this._entries.length=0}setProp(e,t,s){const r=e[t];e[t]=s,this.push({obj:e,propName:t,prevValue:r,revert(){this.obj[t]=s}})}setAttr(e,t,s){const r=e.getAttribute(t);e.setAttribute(t,void 0===s?"":s),this.push({elem:e,attrName:t,prevValue:r,revert(){null===this.prevValue?this.elem.removeAttribute(this.attrName):this.elem.setAttribute(this.attrName,this.prevValue)}})}setStyle(e,t){const s={};for(const r in t)s[r]=e.style.getPropertyValue(r),e.style.setProperty(r,t[r]),e.getAttribute("style")||e.removeAttribute("style");this.push({elem:e,beforeProps:s,revert(){for(const e in this.beforeProps)this.elem.style.setProperty(e,this.beforeProps[e]);this.elem.getAttribute("style")||this.elem.removeAttribute("style")}})}breaks(e,t,s){const r=breaks_1.breakAtPoint(e,t,s);return this.push({before:"before"==s?r:e,after:"before"==s?e:r,position:s,revert(){breaks_1.unbreak(this.before,this.after,"before"==this.position?"after":"before")}}),r}insertNode(e,t,s){e.insertBefore(t,s),this.push({node:t,revert(){this.node.remove()}})}appendNodeContents(e,t){const s=t.lastChild;ranges_1.default.appendNodeContents(e,t),this.push({srcNode:e,dstNode:t,lastDstChild:s,revert(){const e=document.createRange();e.selectNodeContents(this.dstNode),this.lastDstChild&&e.setStartAfter(this.lastDstChild),this.srcNode.appendChild(e.extractContents())}})}}exports.Mutations=Mutations,exports.default=Mutations;

},{"./breaks":1,"./util/ranges":21}],14:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createPage=exports.Paginator=exports.Page=exports.Sequence=void 0;const fragments_1=require("./fragments"),util_1=require("./util"),flow_1=require("./flow"),columns_1=require("./columns"),gcpm_1=require("./gcpm"),breaks_1=require("./breaks"),css_1=require("./css");class Sequence{constructor(e){this.startPageIndex=-1,this.endPageIndex=-1,this.range=e.range.startContainer.ownerDocument.createRange(),this.pageName=e.pageName,this.pageGroupStart=e.pageGroupStart,this.breakType=e.breakType,this.breakPoint={container:e.range.endContainer,offset:e.range.endOffset}}}exports.Sequence=Sequence;class Page extends fragments_1.Fragment{}exports.Page=Page;class Paginator extends fragments_1.Fragmentor{constructor(e){super(e&&e.source||document.body,e),this.sequences=[],this.avoidBreakTypes=["avoid","avoid-page"],this.forcedBreakTypes=["always","page","left","right","recto","verso"],this.addSubProcessor(columns_1.columnsSubProcessor),this._process=this.paginationProcess()}get pages(){return this.fragments}get currentPage(){return this.currentFragment}set currentPage(e){this.currentFragment=e}*paginationProcess(){if(!this.source)throw new Error("The pagination source is undefined");if(this.source.closest("[ps-process=pending]"))throw new Error("Fragmentation already underway on this source.");if(this.source==this.source.ownerDocument.documentElement)throw new Error("Pagination source cannot be the document element");this.dest.setAttribute("ps-process","pending"),this.listenerCount("start")&&(yield"start"),util_1.walk.firstChild(this.source,util_1.walk.isStaticNode)||util_1.logger.warn("The pagination source has no static child");const e=[window.scrollX,window.scrollY];util_1.dom.id(this.dest);let t=css_1.cssContexts.get(this.doc);t||(t=new css_1.CssContext(this.doc,this.options),css_1.cssContexts.set(this.doc,t),yield*t.process()),this.listenerCount("preparation-start")&&this.emit("preparation-start");const s=util_1.walk.createIterator(this.source);let r,n;for(;r=s.nextNode();)if(this.listenerCount("prepare")&&this.emit({type:"prepare",node:r}),util_1.walk.isElement(r)){css_1.REGISTER_PROPERTIES&&r.hasAttribute("style")&&(yield t.processStyleAttr(r));const e=getComputedStyle(r);if("none"!=e.display){r instanceof HTMLTableElement&&r.caption&&"bottom"==e.captionSide&&r.appendChild(r.caption);const s=css_1.getCustomStyle(r);if(gcpm_1.prepareGcpm(r,s,this.gcpmContext),util_1.walk.isHTMLElement(r)){let s=t.testHyphens(r,e);s&&(s instanceof Promise&&(s=yield s),s&&t.hyphenate(r,s))}}}for(this.listenerCount("preparation-end")&&this.emit("preparation-end"),this.source.style.display="none",this.listenerCount("pagination-start")&&(yield"pagination-start"),this.flowIterator=new flow_1.FlowIterator(this.source,this.forcedBreakTypes,this.options.maxFragmentTextLength);n=this.flowIterator.next();)this.firstPageSide||(this.firstPageSide="left"==n.breakType?"left":"right"),yield*this.sequenceProcess(n);this.onPageEnd(this.currentPage,!0);const a=getComputedStyle(this.dest).counterReset;this.dest.style.counterReset=("none"==a?"":a)+" pages "+this.pages.length;let o=null;this.options.bookmarks&&(o=gcpm_1.createBookmarks(this.doc,this.gcpmContext),this.dest.insertBefore(o,this.pages[0].container)),gcpm_1.setTargetCounters(this.pages,this.gcpmContext),o&&gcpm_1.setBookmarkLabels(o),gcpm_1.setLeaders(this.gcpmContext),yield Promise.all(Array.from(this.imagesToLoad,e=>new Promise(t=>{const s=new Image;s.onload=t,s.onerror=t,s.src=e}))),this.source.remove(),this.dest.setAttribute("ps-process","ended"),this.listenerCount("pagination-end")&&(yield"pagination-end"),window.scrollTo(...e),this.listenerCount("end")&&(yield"end")}*sequenceProcess(e){this.previousSequence=this.currentSequence;const t=this.currentSequence=new Sequence(e);if(this.sequences.push(t),this.listenerCount("sequence-start")&&(yield{type:"sequence-start",sequence:t}),this.pages.length){const e=(this.pages.length+("left"==this.firstPageSide?1:0))%2?"left":"right";("left"==t.breakType&&"right"==e||"right"==t.breakType&&"left"==e||"verso"==t.breakType&&e==this.firstPageSide||"recto"==t.breakType&&e!=this.firstPageSide)&&(yield*this.pageProcess(!0))}for(e.range.setStartBefore(this.source.firstChild);!e.range.collapsed;){if(yield*this.pageProcess(!1,e.maxTextLength),this.layoutContext&&(e.range.setStart(this.layoutContext.breakPoint.container,this.layoutContext.breakPoint.offset),e.range.setEndAfter(this.currentPage.body.lastChild)),e.maxTextLength&&(!this.layoutContext||e.range.collapsed)){this.layoutContext?util_1.logger.debug("Max flow text length reached (after contents processing)."):util_1.logger.debug("Max flow text length reached (before contents processing).");const t=this.currentPage.body;this.layoutContext&&this.layoutContext.mutations.revert(),this.fragmentStartMut.revert(),breaks_1.unbreak(t,this.source,"after"),e=this.flowIterator.next(),yield*this.continuePageProcess(this.currentPage,e),e.range.setStart(this.layoutContext.breakPoint.container,this.layoutContext.breakPoint.offset),e.range.setEndAfter(this.currentPage.body.lastChild)}this.fragmentStartMut.commit(),this.layoutContext.mutations.commit(),this.listenerCount("page-end")&&(yield{type:"page-end",page:this.currentPage})}this.currentPage.container.removeAttribute("ps-processing"),this.listenerCount("sequence-end")&&(yield{type:"sequence-end",sequence:t})}*pageProcess(e,t=!1){const s=this.currentPage;s&&util_1.logger.removeScope();const r=(this.pages.length+("right"==this.firstPageSide?0:1))%2?"left":"right",n=e&&this.previousSequence||this.currentSequence,a=this.currentPage=createPage(this.doc,n,n.pageName,r,this.pages.length+1,e);if(this.pages.push(a),util_1.logger.addScope(`page ${a.number}`),-1!=this.currentSequence.startPageIndex||e||(this.currentSequence.startPageIndex=this.pages.length-1),this.currentSequence.endPageIndex=this.pages.length-1,this.dest.appendChild(a.container),this.listenerCount("page-start")&&(yield{type:"page-start",page:a}),this.setBleedAndMarks(a),e)return a.body=a.area.appendChild(s.body.cloneNode(!1)),this.onPageEnd(s),this.listenerCount("page-end")&&(yield{type:"page-end",page:a}),void util_1.logger.removeScope();const o=this.pages[this.currentSequence.startPageIndex];let i;a==o?i=breaks_1.breakAtPoint(this.source,this.currentSequence.breakPoint,"before"):(i=breaks_1.breakAtPoint(s.body,this.layoutContext.breakPoint),this.onFragmentBreak(s)),this.layoutContext=null,i.style.display="",i.setAttribute("ps-page-body",""),a.body=a.area.appendChild(i),fragments_1.createAreas(a),a.container.setAttribute("ps-processing",""),s&&(s.container.removeAttribute("ps-processing"),this.onPageEnd(s)),this.onFragmentStart(a,a==o),t&&i.scrollHeight<=i.clientHeight||(yield*this.contentsProcess(a.body,a.areas))}*continuePageProcess(e,t){const s=breaks_1.breakAtPoint(this.source,{container:t.range.endContainer,offset:t.range.endOffset},"before");s.style.display="",s.setAttribute("ps-page-body",""),e.body=e.area.insertBefore(s,e.area.firstChild),this.onFragmentStart(e,!1),yield*this.contentsProcess(e.body,e.areas)}addImagesToLoad(e){super.addImagesToLoad(e);for(const t in e.marginBoxes)css_1.addStyleImagesToLoad(e.marginBoxes[t],this.imagesToLoad)}onPageEnd(e,t=!1){gcpm_1.setMarginContents(e,this.gcpmContext),gcpm_1.setPageTargetCounters(e,this.dest,this.gcpmContext),t&&e.body.removeAttribute("ps-breaked-after")}setBleedAndMarks(e){const t=getComputedStyle(e.container),s=css_1.getCustomProp(t,"bleed");let r=css_1.getCustomProp(t,"bleed-size");const n=css_1.getCustomProp(t,"marks");"auto"==s&&n.includes("crop")&&(r="6pt",e.container.style.setProperty("--ps-bleed-size",r)),parseFloat(r)&&e.container.setAttribute("ps-bleed",n)}}function createPage(e,t,s,r,n,a){const o=new Page;o.container=e.createElement("ps-page"),o.parentSequence=t,o.side=r,o.number=n,o.blank=a,s&&o.container.setAttribute("ps-name",s);let i=r;1==n&&(i+=" first"),a?i+=" blank":t.pageGroupStart&&(i+=" first-of-group",t.pageGroupStart=!1),o.container.setAttribute("ps-pseudos",i),o.marginBoxes={};for(let t=0;t<gcpm_1.SIDES.length;t++){const s=e.createElement("ps-margin-box");s.setAttribute("ps-name",gcpm_1.CORNERS[t]),o.marginBoxes[gcpm_1.CORNERS[t]]=s,o.container.appendChild(s);const r=e.createElement("ps-margin");r.setAttribute("ps-side",gcpm_1.SIDES[t]);const n=t%2==0?gcpm_1.HORIZONTAL_MARGIN_BOXES:gcpm_1.VERTICAL_MARGIN_BOXES;for(const s of n){const n=e.createElement("ps-margin-box"),a=gcpm_1.SIDES[t]+"-"+s;n.setAttribute("ps-name",a),r.appendChild(n),o.marginBoxes[a]=n}o.container.appendChild(r)}return o.area=e.createElement("ps-page-area"),o.container.appendChild(o.area),o}exports.Paginator=Paginator,Paginator.defaultOptions=Object.assign(Object.create(fragments_1.Fragmentor.defaultOptions),{source:null,bookmarks:!0,debug:!1,maxFragmentTextLength:1e4}),exports.createPage=createPage;

},{"./breaks":1,"./columns":2,"./css":4,"./flow":7,"./fragments":8,"./gcpm":9,"./util":20}],15:[function(require,module,exports){
...
},{"./breaks":1,"./columns":2,"./counters":3,"./css":4,"./flow":7,"./fragments":8,"./gcpm":9,"./layout":12,"./pages":14,"./precss":16,"./process":17,"./rows":18,"./shim":19,"./util":20}],16:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.importFold=exports.importUnfold=exports.replaceMediaType=exports.styleAttrPlugin=void 0;const postcss=require("postcss"),valueParser=require("postcss-value-parser"),util_1=require("./util"),defaultOptions={defaultPageSize:["210mm","297mm"]},GCPM_CONTENT_FUNCS=["target-text","target-content","target-counter","target-counters","leader","element","string"],SIDES=["top","right","bottom","left"],AREA_CSS_PROPS=["margin","padding","border","outline","grid","display"],CONTENT_PSEUDOS_RE=/::(before|after|marker)\s?/,SINGLE_COLON_PSEUDO_RE=/(^|[^:]):(before|after|first-letter|first-line)/g,PROPS_TO_PREFIX_RE=/^(?:size|page|break-.+|page-break-.+|orphans|widows|bookmark-.+|string-set|position|float|footnote-.+|margin-break|box-decoration-break|bleed|marks|columns|column-.+|hyphens|-ps-.+|-psp-.+)$/,PAGE_BREAKS=["auto","avoid","always","page","left","right","recto","verso"],URI_PROPS_RE=/^(--.+|.+-image|background|list-style|cursor|content|border|border-image-source|mask|-webkit-mask|src|symbols)$/,PSEUDO_TO_ATTR_RE=/:-(ps-breaked-(before|after))/g,FLOAT_PSEUDO_RE=/^(.*)::(-ps-float|footnote)-(marker|call)$/,COLUMNS_PSEUDO_RE=/^(.*)::-ps-columns(\b.+)?$/,NOT_VAL_NODE={type:"word",value:"not"},SPACE_VAL_NODE={type:"space",value:" "},COMMA_VAL_NODE={type:"div",value:","},HREF_VAL_NODE={type:"word",value:"href"};function selectMediaType(e,s){e.walkAtRules(/^media|import\b/,e=>{e.params=replaceMediaType(e.params,s.mediaType)})}function replaceMediaType(e,s){const o=valueParser(e),t=[];for(let e=0;e<o.nodes.length;e++){const r=o.nodes[e];if("word"==r.type&&"and"!=r.value)if("not"==r.value){const a=o.nodes[e+2];a.value!=s&&"all"!=a.value||t.push(r,SPACE_VAL_NODE),a.value="all",t.push(a),e+=2}else"only"!=r.value&&(r.value!=s&&"all"!=r.value&&t.push(NOT_VAL_NODE,SPACE_VAL_NODE),r.value="all",t.push(r));else t.push(r)}return valueParser.stringify(t)}function css3Pseudos(e){e.walkRules(e=>{e.selector=e.selector.replace(SINGLE_COLON_PSEUDO_RE,"$1::$2")})}function replaceAtPageRules(e,s){const o=new Set;e.walkAtRules(/^page\b/,e=>{const t=postcss.list.comma(e.name.substr(4)+e.params),r=e.parent;for(const a of t){let t="ps-page";const p=a.replace(/:/g," :").split(" ");let n=null;for(const e of p)e&&(":"==e[0]?e.startsWith(":nth(")?t+=":nth-of-type"+e.substr(4):e.startsWith(":first")?t+=n?"[ps-pseudos~=first-of-group][ps-pseudos]":`[ps-pseudos~=${e.substr(1)}][ps-pseudos]`:t+=`[ps-pseudos~=${e.substr(1)}]`:t+=`[ps-name=${n=e}]`);const l=postcss.rule({selector:t});l.source=e.source;const c=postcss.rule({selector:t+" > ps-page-area"});c.source=e.source;for(const t of e.nodes)if("decl"==t.type){const e=t;if("size"==e.prop){const r=getPageSize(e.value,s.defaultPageSize);o.add(r.join(" "));const a=postcss.decl({prop:"--ps-page-width",value:r[0].toString()}),p=postcss.decl({prop:"--ps-page-height",value:r[1].toString()});p.source=t.source,l.append(a),l.append(p),l.append(t.clone())}else if(AREA_CSS_PROPS.some(s=>e.prop.startsWith(s)))if("margin"==e.prop){const e=expandSideDecl(t);for(const[s,o]of SIDES.entries())l.append(t.clone({prop:`--ps-page-margin-${o}`,value:pageMarginValue(e[s],o)}))}else if(e.prop.startsWith("margin-")){const s=e.prop.substr(7);l.append(t.clone({prop:`--ps-page-margin-${s}`,value:pageMarginValue(e.value,s)}))}else if("padding"==e.prop){const s=expandSideDecl(t);for(const[o,r]of SIDES.entries())c.append(t.clone({prop:e.prop+"-"+r,value:pageMarginValue(s[o],r)}))}else if(e.prop.startsWith("padding-")){const s=e.prop.substr(7);c.append(t.clone({prop:e.prop,value:pageMarginValue(e.value,s)}))}else c.append(t.clone());else"width"!=e.prop&&"height"!=e.prop&&l.append(t.clone())}l.nodes.length&&r.insertBefore(e,l),c.nodes.length&&r.insertBefore(e,c);for(const s of e.nodes)if("atrule"==s.type){const o=s,a=o.name.startsWith("footnote");if("-ps-body"==o.name){const s=postcss.rule({selector:`${t} > ps-page-area > [ps-page-body]`});for(;o.first;)s.append(o.first);s.append(postcss.decl({prop:"grid-area",value:"-ps-body"})),r.insertBefore(e,s)}else if("-ps-area"==o.name||a){a&&(o.params=o.name+o.params);const s=o.params.match(/^(.+?)\b(.*)$/);let p=s[1];"footnote"==p&&(p="footnotes");const n=postcss.rule({selector:`${t} > ps-page-area > ps-area[ps-name=${p}]${s[2].trim()}`});for(;o.first;)n.append(o.first);n.append(postcss.decl({prop:"grid-area",value:p})),r.insertBefore(e,n)}else if(o.name.startsWith("-ps-")){const s=o.name.substr(4);if(SIDES.includes(s)){const a=postcss.rule({selector:`${t} > ps-margin[ps-side=${s}]`});for(;o.first;)a.append(o.first);r.insertBefore(e,a)}}else{const s=o.name.substr(0,o.name.indexOf("-")),a=o.name.endsWith("-corner")?`${t} > ps-margin-box[ps-name=${o.name}]`:`${t} > ps-margin[ps-side=${s}] > ps-margin-box[ps-name=${o.name}]`,p=postcss.rule({selector:a});for(p.source=o.source;o.first;)p.append(o.first);for(const s of p.nodes)if("content"==s.prop){const o=postcss.rule({selector:a+"::before"});o.append(s),r.insertBefore(e,o);break}p.nodes.length&&r.insertBefore(e,p)}}}e.remove()})}function expandSideDecl(e){const s=postcss.list.space(e.value);let o=new Array(4);switch(s.length){case 1:for(let e=0;e<4;e++)o[e]=s[0];break;case 2:o[0]=o[2]=s[0],o[1]=o[3]=s[1];break;case 3:o[0]=s[0],o[1]=o[3]=s[1],o[2]=s[2];break;case 4:o=s}return o}function pageMarginValue(e,s){const o="top"==s||"bottom"==s?"height":"width";return e.endsWith("%")?`calc(var(--ps-page-${o}) * ${parseFloat(e)} / 100)`:e}function getPageSize(e,s){let o=null;const t=postcss.list.space(e),r=t[t.length-1],a="landscape"==r;if(("portrait"==r||a)&&(t.pop(),t.length||t.push("auto")),t.length&&t[0].match(/^[a-z]/i))switch(t[0].toLowerCase()){case"a5":o=["148mm","210mm"];break;case"a4":o=["210mm","297mm"];break;case"a3":o=["297mm","420mm"];break;case"b5":o=["176mm","250mm"];break;case"b4":o=["250mm","353mm"];break;case"jis-b5":o=["182mm","257mm"];break;case"jis-b4":o=["257mm","364mm"];break;case"letter":o=["8.5in","11in"];break;case"legal":o=["8.5in","14in"];break;case"ledger":o=["11in","17in"];break;case"auto":o=s;break;case"a6":o=["105mm","148mm"];break;case"a7":o=["74mm"," 105mm"];break;case"a8":o=["52mm","74mm"];break;case"a9":o=["37mm","52mm"];break;case"a10":o=["26mm","37mm"]}return o||(o=t.length>=2?[t[0],t[1]]:[t[0],t[0]]),a&&(o=[o[1],o[0]]),o}function prefixProps(e,s){e.walkRules(e=>{e.selector=e.selector.replace(PSEUDO_TO_ATTR_RE,"[$1]");const o=prefixPropsDecls(e);if(o.length)if(s.propertiesRegistered)for(const s of o)e.append(s);else{const s=postcss.rule();s.selectors=e.selectors.map(e=>e+"::backdrop"),e.parent.insertBefore(e,s);for(const e of o)s.append(e)}})}function prefixPropsDecls(e){const s=[];return e.walkDecls(PROPS_TO_PREFIX_RE,o=>{let t,r,a=!1;if(o.prop.startsWith("column")&&e.walkDecls(/^-webkit-column/,e=>{e.remove()}),o.prop.startsWith("page-break-"))PAGE_BREAKS.includes(o.value)?((r=o.clone()).prop=o.prop.replace(/^page-break-/,"--ps-break-"),"always"==o.value?r.value="page":"avoid"==o.value&&(r.value="avoid-page"),t=!0):o.remove();else if("position"==o.prop)(t=o.value.match(/^running\(/))||(a=!0);else if("float"==o.prop)"footnote"==o.value?(o.value="-ps-area(footnotes)",t=!0):t=o.value.match(/^-ps-area\(/),t||(a=!0);else if(o.prop.startsWith("footnote-"))o.prop=o.prop.replace("footnote-","-ps-float-"),t=!0;else if("orphans"==o.prop||"widows"==o.prop)o.value.match(/^\d+$/)&&parseInt(o.value)>0?o.prop="--ps-"+o.prop:o.remove();else if("columns"==o.prop||"-ps-columns"==o.prop){const e=o.cloneAfter();e.prop="-ps-column-width";const s=valueParser(o.value).nodes.filter(e=>"word"==e.type).map(e=>e.value);s[0].match(/^\d+$/)?(o.value=s[0],e.value=s[1]||"auto"):s.length>1&&s[1].match(/^\d+$/)?(o.value=s[1],e.value=s[0]||"auto"):(o.value="auto",e.value="auto"==s[0]?s[1]||"auto":s[0]),o.prop="-ps-column-count",t=!0}else"hyphens"==o.prop?"auto"==o.value&&(o.cloneBefore({value:"manual"}),o.prop="--ps-"+o.prop):"-ps-hyphens"==o.prop?"auto"==o.value&&(o.cloneBefore({prop:"hyphens",value:"manual"}),o.prop="-"+o.prop):"bleed"==o.prop?(o.prop="--ps-bleed",o.cloneBefore({prop:"--ps-bleed-size",value:"auto"==o.value?"0px":o.value})):"marks"==o.prop?o.prop="--ps-"+o.prop:t=!0;(t||a)&&(r||(r=o.clone(),o.prop.startsWith("-ps-")?r.prop="-"+o.prop:o.prop.startsWith("-psp-")?r.prop="-"+o.prop:r.prop="--ps-"+o.prop,a&&(r.value="")),s.push(r),a||o.remove())}),s}function replacePseudos(e){e.walkRules(e=>{const s=e.selectors.slice();for(let o=0;o<s.length;o++){const t=s[o].match(FLOAT_PSEUDO_RE);if(t){const[,r,a,p]=t;if("call"==p){let t=`[ps-float-${p}]`;r&&(t=r+" + "+t),"footnote"==a&&(t+='[ps-float-area="footnotes"]'),s[o]=t;const n=e.clone({selector:t+"::before",nodes:[]});e.walkDecls("content",e=>{const t=valueParser(e.value);for(const e of t.nodes)"function"==e.type&&"counter"==e.value&&(e.value="target-counter",e.nodes.unshift({type:"function",value:"attr",nodes:[HREF_VAL_NODE]},COMMA_VAL_NODE));e.value=t.toString(),o==s.length-1?n.append(e):n.append(e.clone())}),n.nodes.length&&e.parent.insertBefore(e,n)}else{let e="footnote"==a?'[ps-float="footnotes"]':"[ps-float]";s[o]=`${r}${e}[ps-float-display=block]::marker`,s.push(`${r}${e}:not([ps-float-display=block])::before`)}}const r=s[o].match(COLUMNS_PSEUDO_RE);if(r){const[,s,o]=r;e.cloneAfter().selectors=[`${s} > ps-columns > ps-column > ps-column-body${o}`,`${s} > ps-column-body${o}`]}}e.selectors=s})}function replaceContent(e){e.walkRules(CONTENT_PSEUDOS_RE,e=>{let s=null,o=!1;if(e.walkDecls("content",e=>{s=e;const t=valueParser(e.value);for(const e of t.nodes)if("function"==e.type&&GCPM_CONTENT_FUNCS.includes(e.value)){o=!0;break}}),!s)return;const t={},r=e.selectors.slice();for(const s of r){const o=s.match(CONTENT_PSEUDOS_RE),r=o?o[1]:"";let a=t[r];a?a.selector+=", ":(a=t[r]=Object.keys(t).length?e.cloneBefore():e).selector="",a.selector+=s}for(const e in t)if(e){const r=t[e];o?r.walkDecls("content",s=>{const o=valueParser(s.value),t=o.nodes.findIndex(e=>"function"==e.type&&"leader"==e.value);-1!=t&&replaceLeader(r,s,o,e,t);const a=[];o.walk((s,o,t)=>{if("function"==s.type&&GCPM_CONTENT_FUNCS.includes(s.value))return t[o]=valueParser(`var(--ps-${e}-val-${a.length}, "")`).nodes[0],a.push(s),!1}),s.value=o.toString(),r.insertAfter(s,s.clone({prop:`--ps-${e}-vals`,value:a.map(e=>valueParser.stringify(e)).join(" ")}))}):r.append(s.clone({prop:`--ps-${e}-vals`,value:"none"}))}})}function replaceLeader(e,s,o,t,r){const a=e.selectors.map(e=>{return`${e.substring(0,e.indexOf("::"+t))} > ps-leader[ps-position=${t}]`}).join(", ");e.cloneAfter({selector:a}).walkDecls("content",e=>e.remove())}function load(e){return new Promise((s,o)=>{const t=new XMLHttpRequest;t.open("GET",e),t.onload=(()=>s(t.responseText)),t.onerror=(()=>o(new Error(`Unable to fetch '${e}'`))),t.send()})}exports.default=postcss.plugin("ps-precss",e=>{let s=Object.assign(Object.create(defaultOptions),e);return e=>(s.mediaType&&selectMediaType(e,s),css3Pseudos(e),replaceAtPageRules(e,s),prefixProps(e,s),replacePseudos(e),replaceContent(e),e)}),exports.styleAttrPlugin=postcss.plugin("ps-precss-styleattr",()=>e=>{const s=prefixPropsDecls(e);for(const o of s)e.append(o)}),exports.replaceMediaType=replaceMediaType,exports.importUnfold=postcss.plugin("ps-import-unfold",e=>s=>{const o=[];return s.walkAtRules("import",s=>{const t=valueParser(s.params).nodes[0];var r;if("string"==t.type?r=new URL(t.value,e.from):"function"==t.type&&"url"==t.value&&t.nodes.length&&(r=new URL(t.nodes[0].value,e.from)),r){const t=Object.create(e);t.from=r.href;const a=load(r.href).then(e=>{return postcss().use(exports.importUnfold(t)).process(e,t)}).then(e=>{s.append(e.root.nodes)}).catch(e=>{util_1.logger.warn(e)});o.push(a)}}),s.walkDecls(URI_PROPS_RE,s=>{const o=valueParser(s.value);o.walk(s=>{if("function"==s.type&&s.value,"function"==s.type&&"url"==s.value){const o=s.nodes[0];"word"==o.type&&Object.assign(o,{type:"string",quote:'"'});const t=new URL(o.value,e.from);o.value=t.href}}),s.value=o.toString()}),Promise.all(o)}),exports.importFold=postcss.plugin("ps-import-fold",()=>{return function e(s){s.walkAtRules("import",s=>{if(s.nodes){e(s);const o=postcss.list.space(s.params),t=postcss.root();t.nodes=s.nodes,delete s.nodes;const r=new Blob([t.toString()],{type:"text/css"});o[0]=`url(${URL.createObjectURL(r)})`,s.params=o.join(" ")}})}});

},{"./util":20,"postcss":49,"postcss-value-parser":32}],17:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const ranges_1=require("./ranges");var rects;!function(t){function o(t,o){return{top:t.top+o.scrollY,bottom:t.bottom+o.scrollY,left:t.left+o.scrollX,right:t.right+o.scrollX,width:t.width,height:t.height}}t.boundingScrollRect=function(t){return ranges_1.default.isRange(t)?o(t.getBoundingClientRect(),t.commonAncestorContainer.ownerDocument.defaultView):o(t.getBoundingClientRect(),t.ownerDocument.defaultView)},t.scrollRect=o,t.rectsLines=function(t,o){const e=[];let r=null;for(const o of t)o.left!=o.right&&(!r||o.bottom>r.bottom&&o.top>r.top&&o.left<=r.left?(r={left:o.left,bottom:o.bottom,right:o.right,top:o.top},e.push(r)):(o.top<r.top&&(r.top=o.top),o.bottom>r.bottom&&(r.bottom=o.bottom),o.right>r.right&&(r.right=o.right)));for(const t of e)t.top+=o.scrollY,t.bottom+=o.scrollY,t.left+=o.scrollX,t.right+=o.scrollX;return e},t.equalRects=function(t,o){return t.top!=o.top||t.right!=o.right||t.bottom!=o.bottom||t.left!=o.left},t.includesRect=function(t,o){return o.top>=t.top&&o.bottom<=t.bottom&&o.left>=t.left&&o.right<=t.right},t.contentSizingHeight=function(t,o){return o-parseFloat(t.paddingTop)-parseFloat(t.paddingBottom)-parseFloat(t.borderTopWidth)-parseFloat(t.borderBottomWidth)}}(rects||(rects={})),exports.default=rects;

},{"./ranges":21}],23:[function(require,module,exports){
"use strict";var walk;Object.defineProperty(exports,"__esModule",{value:!0}),function(e){function t(e){return e&&e.nodeType==Node.ELEMENT_NODE}function n(e){return t(e)&&"innerText"in e}function i(e){return t(e)&&"ownerSVGElement"in e}function r(e){return i(e)&&null==e.ownerSVGElement}function l(e){return e&&e.nodeType==Node.TEXT_NODE}function o(e){return"none"!=e.display&&"table-column-group"!=e.display&&("static"==e.position||"relative"==e.position)}function u(e){return l(e)?0!=e.nodeValue.trim().length:!!t(e)&&o(getComputedStyle(e))}function s(e){return"none"!=e.float||!(e.display.startsWith("inline")||e.display.startsWith("ruby")||e.display.startsWith("table-column"))}e.createWalker=function(e,t,n){return e.ownerDocument.createTreeWalker(e,NodeFilter.SHOW_ALL,{acceptNode:e=>!t||t(e)?NodeFilter.FILTER_ACCEPT:n&&n(e)?NodeFilter.FILTER_SKIP:NodeFilter.FILTER_REJECT})},e.createIterator=function(e,t,n){return e.ownerDocument.createNodeIterator(e,NodeFilter.SHOW_ALL,{acceptNode:e=>!t||t(e)?NodeFilter.FILTER_ACCEPT:n&&n(e)?NodeFilter.FILTER_SKIP:NodeFilter.FILTER_REJECT})},e.firstChild=function(e,t){let n=e?e.firstChild:null;for(;n;){if(t(n))return n;n=n.nextSibling}return null},e.lastChild=function(e,t){let n=e?e.lastChild:null;for(;n;){if(t(n))return n;n=n.previousSibling}return null},e.nextSibling=function(e,t){let n=e?e.nextSibling:null;for(;n;){if(t(n))return n;n=n.nextSibling}return null},e.previousSibling=function(e,t){let n=e?e.previousSibling:null;for(;n;){if(t(n))return n;n=n.previousSibling}return null},e.ancestor=function(e,t,n){let i=e.parentNode;for(;i&&i!==n;){if(t(i))return i;i=i.parentNode}return null},e.ancestorOrSelf=function(e,t,n){let i=e;for(;i&&i!==n;){if(t(i))return i;i=i.parentNode}return null},e.next=function e(t,n,i){let r=t.firstChild;if(r)return n(r)?r:e(r,n,i);if(t===i)return null;for(;!(r=t.nextSibling);)if((t=t.parentNode)===i)return null;return n(r)?r:e(r,n,i)},e.previous=function e(t,n,i){if(t===i)return null;let r=t.previousSibling;if(r){let t=r.lastChild;for(;t;)r=t,t=t.lastChild;return n(r)?r:e(r,n,i)}return(r=t.parentNode)===i?null:n(r)?r:e(r,n,i)},e.all=function(e,t,n,i){const r=[];let l=t;for(;l=e(l,n,i);)r.push(l);return r},e.isNode=function(e){return!0},e.isElement=t,e.isHTMLElement=n,e.isSVGElement=i,e.isSVGRootSVGElement=r,e.isHTMLOrSVGRootSVGElement=function(e){return n(e)||r(e)},e.isText=l,e.isConstructedBy=function(e){return function(t){return t.constructor==e}},e.isInstanceOf=function(e){return function(t){return t instanceof e}},e.isStaticStyle=o,e.isStatic=u,e.isRow=function(e){return"table-row"==e.display?"table-row":!("flex"!=e.display||!e.flexDirection.startsWith("row"))&&"flex-row"},e.predicate=function(e,...t){return n=>!(e&&!e(n))&&t.every(e=>e(n))},e.displayAsBlockStyle=s,e.displayAsBlock=function(e){return!l(e)&&(t(e)?s(getComputedStyle(e)):void 0)},e.displayAsInlineBlock=function(e){if(l(e))return!1;if(t(e)){const t=getComputedStyle(e);return t.display.startsWith("inline-")||"inline"==t.display&&e instanceof SVGElement}},e.isDisplayed=function(e){return"none"!=getComputedStyle(e).display},e.hasSize=function(e){return 0!=e.clientWidth||0!=e.clientHeight},e.isBreakedAfter=function(e){return e.hasAttribute("ps-breaked-after")},e.isStaticNode=u,e.isStaticElement=e.predicate(e.isElement,e.isStatic),e.isStaticHtmlElement=e.predicate(e.isHTMLElement,e.isStatic),e.isStaticHtmlBlock=e.predicate(e.isHTMLElement,e.isStatic,e.displayAsBlock),e.isBlockElement=e.predicate(e.isElement,e.displayAsBlock),e.isInlineBlockElement=e.predicate(e.isElement,e.displayAsInlineBlock)}(walk||(walk={})),exports.default=walk;
...
},{"./safe-parser":31,"postcss/lib/input":42}],31:[function(require,module,exports){
...
},{"postcss/lib/comment":38,"postcss/lib/parser":48,"postcss/lib/tokenize":57}],32:[function(require,module,exports){
...
},{"./parse":33,"./stringify":34,"./unit":35,"./walk":36}],33:[function(require,module,exports){
...
},{"./css-syntax-error":40,"./previous-map":50,"path":28}],43:[function(require,module,exports){
(function (process){(function (){
...
},{"./map-generator":45,"./parse":47,"./result":52,"./stringify":56,"./warn-once":59,"_process":72}],44:[function(require,module,exports){
...
},{"buffer":26,"path":28,"source-map":71}],46:[function(require,module,exports){
(function (process){(function (){
...
},{"./css-syntax-error":40,"./stringifier":55,"./stringify":56,"_process":72}],47:[function(require,module,exports){
(function (process){(function (){
...
},{"./input":42,"./parser":48,"_process":72}],48:[function(require,module,exports){
...
},{"./at-rule":37,"./comment":38,"./declaration":41,"./root":53,"./rule":54,"./tokenize":57}],49:[function(require,module,exports){
...
},{"./at-rule":37,"./comment":38,"./declaration":41,"./list":44,"./parse":47,"./processor":51,"./root":53,"./rule":54,"./stringify":56,"./vendor":58}],50:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"./warning":60}],53:[function(require,module,exports){
...
},{"./container":39,"./lazy-result":43,"./processor":51}],54:[function(require,module,exports){
...
},{"./container":39,"./list":44}],55:[function(require,module,exports){
...
},{"./stringifier":55}],57:[function(require,module,exports){
